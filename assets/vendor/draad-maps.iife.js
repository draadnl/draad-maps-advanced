...
`;class Jd extends HTMLElement{#t;#n=!1;#e;#i=null;map;RDnew;constructor(){super(),this.#t=this.attachShadow({mode:"open"}),this.#t.innerHTML=`
		...
		`,this.#e=this.#a()}#a(){const e=new CSSStyleSheet;e.replaceSync($d);const n=new CSSStyleSheet;n.replaceSync(Wd);const s=new CSSStyleSheet;s.replaceSync(Vd);const a=new CSSStyleSheet;a.replaceSync(ms),this.#t.adoptedStyleSheets=[e,n,s,a]}get zoomPosition(){const e={"top-left":"topleft","top-right":"topright","bottom-left":"bottomleft","bottom-right":"bottomright"},n=this.getAttribute("zoom-position");return e[n]??"bottomleft"}get center(){const e=this.getAttribute("center");if(!e)return[52.0705,4.3007];const[n,s]=e.split(",").map(Number);return[n,s]}get zoom(){const e=this.getAttribute("zoom");return e!==null?Number(e):12}get maxBounds(){const e=this.getAttribute("max-bounds");if(e==="false"||e==="")return null;if(!e)return[[50.6,3],[53.8,7.3]];const[n,s,a,l]=e.split(",").map(Number);return[[n,s],[a,l]]}get tileUrl(){return this.getAttribute("tile-url")??"https://service.pdok.nl/brt/achtergrondkaart/wmts/v2_0/standaard/EPSG:3857/{z}/{x}/{y}.png"}get tileAttribution(){return this.getAttribute("tile-attribution")??'Kaartgegevens: <a href="https://www.kadaster.nl">Kadaster</a>'}get minZoom(){const e=this.getAttribute("min-zoom");return e!==null?Number(e):1}get maxZoom(){const e=this.getAttribute("max-zoom");return e!==null?Number(e):19}async connectedCallback(){this.#n||(await this.#e,Ut(this.#t),this.initialize())}initialize(){this.#n=!0,this.RDnew=Zd();const e=G.map(this.#t.querySelector(".map__canvas"),{center:this.center,worldCopyJump:!0,zoom:this.zoom,zoomControl:!1});this.maxBounds&&e.setMaxBounds(this.maxBounds),this.map=e,G.control.zoom({position:this.zoomPosition}).addTo(this.map);const n=this.#t.querySelector(".leaflet-control-zoom-in"),s=this.#t.querySelector(".leaflet-control-zoom-out");n&&(n.innerHTML='<svg class="map__zoom-icon" aria-hidden="true"><use href="#icon-plus"/></svg>'),s&&(s.innerHTML='<svg class="map__zoom-icon" aria-hidden="true"><use href="#icon-minus"/></svg>'),G.tileLayer(this.tileUrl,{maxZoom:this.maxZoom,minZoom:this.minZoom,attribution:this.tileAttribution}).addTo(this.map),this.#i=new ResizeObserver(()=>{this.map&&this.map.invalidateSize()}),this.#i.observe(this.#t.querySelector(".map__canvas")),this.addEventListener("dm-list:open",()=>this.#r()),this.addEventListener("dm-list:close",()=>this.#s()),this.addEventListener("dm-infowindow:open",a=>this.#o(a.target)),this.dispatchEvent(new CustomEvent("dm-map:ready",{bubbles:!0,composed:!0,detail:{map:this.map}}))}#o(e){const n=e?.shadowRoot?.querySelector(".infowindow"),s=e?.shadowRoot?.querySelector(".infowindow__body"),a=this.#t.querySelector(".map__position--top-right");if(!n||!s||!a)return;const l=this.getBoundingClientRect(),h=parseFloat(getComputedStyle(a).insetInlineEnd)||10,c=this.#t.querySelector(".leaflet-control-zoom");let u=h;if(c){const _=c.getBoundingClientRect(),g=a.getBoundingClientRect(),w=g.left<_.right&&g.right>_.left,x=_.top>l.top+l.height/2;w&&x&&(u=l.bottom-_.top+h)}this.style.setProperty("--draad-map-components-infowindow-offset-bottom",`${Math.ceil(u)}px`);const v=n.offsetHeight+(s.scrollHeight-s.clientHeight)-a.clientHeight;if(v>0){const _=Math.ceil(l.height+v),g=parseFloat(this.style.getPropertyValue("--draad-map-components-map-content-min-height"))||0;_>g&&this.style.setProperty("--draad-map-components-map-content-min-height",`${_}px`)}}#r(){this.querySelectorAll("dm-infowindow").forEach(a=>{a.isOpen&&a.close()});const e=this.#t.querySelector(".map__canvas"),n=this.#t.querySelector(".map__list"),s=this.#t.querySelectorAll(".map__position");this.setAttribute("list-open",""),e.hidden=!0,n.hidden=!1,s.forEach(a=>a.hidden=!0)}#s(){const e=this.#t.querySelector(".map__canvas"),n=this.#t.querySelector(".map__list"),s=this.#t.querySelectorAll(".map__position");this.removeAttribute("list-open"),e.hidden=!1,n.hidden=!0,s.forEach(a=>a.hidden=!1),this.map&&this.map.invalidateSize()}disconnectedCallback(){this.#i&&(this.#i.disconnect(),this.#i=null),this.map&&(this.map.remove(),this.map=null)}}customElements.define("dm-map",Jd);function Ee(i,e){i.hasAttribute("hidden")&&e&&e.remove()}function ni(i,e,n,s){e&&n&&(e.addTo(n),i.removeAttribute("hidden"),i.dispatchEvent(new CustomEvent(`${s}:show`,{bubbles:!0,detail:{layer:e}})))}function ri(i,e,n){e&&(e.remove(),i.setAttribute("hidden",""),i.dispatchEvent(new CustomEvent(`${n}:hide`,{bubbles:!0,detail:{layer:e}})))}class Bi extends HTMLElement{#t=null;#n=null;#e={};#i=!1;#a=!1;marker=null;static get observedAttributes(){return["center","target","icon","icon-hover","icon-active","label","hidden","properties"]}get center(){const e=this.getAttribute("center");if(!e)return null;const[n,s]=e.split(",").map(Number);return[n,s]}set center(e){Array.isArray(e)?this.setAttribute("center",e.join(",")):this.setAttribute("center",e)}get target(){return this.getAttribute("target")}set target(e){this.setAttribute("target",e)}get active(){return this.#a}set active(e){this.#a=!!e,this.#h()}get label(){return this.getAttribute("label")}set label(e){this.setAttribute("label",e)}get properties(){return JSON.parse(this.getAttribute("properties")||"null")}set properties(e){this.setAttribute("properties",JSON.stringify(e))}show(){const e=this.#n||this.#t;this.removeAttribute("hidden"),ni(this,this.marker,e,"dm-marker"),this.dispatchEvent(new CustomEvent("dm-marker:show",{bubbles:!0,composed:!0,detail:{marker:this.marker}}))}hide(){this.setAttribute("hidden",""),ri(this,this.marker,"dm-marker"),this.dispatchEvent(new CustomEvent("dm-marker:hide",{bubbles:!0,composed:!0,detail:{marker:this.marker}}))}toggle(){this.hidden?this.show():this.hide()}connectedCallback(){const e=this.closest("dm-layer"),n=this.closest("dm-map");e?e.layerGroup&&n?.map?this.#l(e.layerGroup,n.map):e.addEventListener("dm-layer:ready",s=>{this.#l(s.detail.layerGroup,s.detail.map)},{once:!0}):n&&(n.map?this.#l(null,n.map):n.addEventListener("dm-map:ready",s=>{this.#l(null,s.detail.map)},{once:!0}))}static#o="data:image/svg+xml,"+encodeURIComponent('<svg xmlns="http://www.w3.org/2000/svg" width="25" height="41" viewBox="0 0 25 41"><path fill="#555" stroke="#333" stroke-width="2" d="M12.5 1C6.15 1 1 6.15 1 12.5c0 9.38 11.5 27.5 11.5 27.5S24 21.88 24 12.5C24 6.15 18.85 1 12.5 1z"/><circle fill="#fff" cx="12.5" cy="12.5" r="5"/></svg>');async#r(e){return e?new Promise(n=>{const s=new Image;s.onload=()=>{const l=30/s.naturalWidth,h=Math.round(s.naturalWidth*l),c=Math.round(s.naturalHeight*l);n(G.icon({iconUrl:e,iconSize:[h,c],iconAnchor:[Math.round(h/2),c],popupAnchor:[0,-c]}))},s.onerror=()=>{n(G.icon({iconUrl:Bi.#o,iconSize:[25,41],iconAnchor:[12,41],popupAnchor:[0,-41]}))},s.src=e}):G.icon({iconUrl:Bi.#o,iconSize:[25,41],iconAnchor:[12,41],popupAnchor:[0,-41]})}async#s(){const e=window.__DRAAD_MAPS_BASE__||"",n=this.getAttribute("icon")||(e?`${e}/markers/marker.png`:null),s=this.getAttribute("icon-hover")||(e?`${e}/markers/marker-hover.png`:null),a=this.getAttribute("icon-active")||(e?`${e}/markers/marker-active.png`:null),[l,h,c]=await Promise.all([this.#r(n),this.#r(s),this.#r(a)]);this.#e={default:l,hover:h,active:c}}async#l(e,n){this.#t=n,this.#n=e;const s=this.center;s&&(await this.#s(),this.marker=G.marker(s,{icon:this.#e.default}),e?this.marker.addTo(e):this.marker.addTo(n),Ee(this,this.marker),this.marker.on("mouseover",()=>{this.#i=!0,this.#h(),this.dispatchEvent(new CustomEvent("dm-marker:hover",{bubbles:!0,composed:!0,detail:{marker:this.marker,hovering:!0}}))}),this.marker.on("mouseout",()=>{this.#i=!1,this.#h(),this.dispatchEvent(new CustomEvent("dm-marker:hover",{bubbles:!0,composed:!0,detail:{marker:this.marker,hovering:!1}}))}),this.marker.on("click",()=>{this.active=!this.active,this.dispatchEvent(new CustomEvent("dm-marker:click",{bubbles:!0,composed:!0,detail:{marker:this.marker,targetId:this.target}}))}))}#h(){this.marker&&(this.#a?this.marker.setIcon(this.#e.active):this.#i?this.marker.setIcon(this.#e.hover):this.marker.setIcon(this.#e.default))}async attributeChangedCallback(e,n,s){if(!(n===s||!this.marker))switch(e){case"center":{const a=this.center;a&&this.marker.setLatLng(a);break}case"hidden":this.hasAttribute("hidden")?this.hide():this.show();break;case"properties":break;case"icon":case"icon-hover":case"icon-active":await this.#s(),this.#h();break}}disconnectedCallback(){this.marker&&(this.marker.off("mouseover"),this.marker.off("mouseout"),this.marker.off("click"),this.marker.remove(),this.marker=null),this.#t=null,this.#n=null}}customElements.define("dm-marker",Bi);function Pe(i,e){return!e||Object.keys(e).length===0?i:i.filter(n=>Object.entries(e).every(([s,a])=>{const l=n.properties?.[s];if(a&&typeof a=="object"&&"min"in a&&"max"in a){const h=Number(l);return isNaN(h)?!1:h>=a.min&&h<=a.max}if(Array.isArray(a)){const h=String(l??"");if(h.includes(",")){const c=h.split(",").map(u=>u.trim());return a.some(u=>c.includes(u))}return a.includes(h)}return!1}))}class Kd extends HTMLElement{#t=null;#n=null;layerGroup=null;static get observedAttributes(){return["name","label","hidden","cluster","cluster-max-zoom","cluster-radius","filter-property","filter-label","filter-properties","filter-labels"]}get name(){return this.getAttribute("name")}set name(e){this.setAttribute("name",e)}get label(){return this.getAttribute("label")}set label(e){this.setAttribute("label",e)}get hidden(){return this.hasAttribute("hidden")}set hidden(e){e?this.setAttribute("hidden",""):this.removeAttribute("hidden")}get filterProperty(){return this.getAttribute("filter-property")}set filterProperty(e){this.setAttribute("filter-property",e)}get filterLabel(){return this.getAttribute("filter-label")}set filterLabel(e){this.setAttribute("filter-label",e)}get filterProperties(){return this.getAttribute("filter-properties")}set filterProperties(e){this.setAttribute("filter-properties",e)}get filterLabels(){return this.getAttribute("filter-labels")}set filterLabels(e){this.setAttribute("filter-labels",e)}get cluster(){return this.hasAttribute("cluster")}set cluster(e){e?this.setAttribute("cluster",""):this.removeAttribute("cluster")}get clusterMaxZoom(){const e=parseInt(this.getAttribute("cluster-max-zoom"));return isNaN(e)||e<0||e>18?16:e}set clusterMaxZoom(e){this.setAttribute("cluster-max-zoom",String(e))}get clusterRadius(){const e=parseInt(this.getAttribute("cluster-radius"));return isNaN(e)||e<=0?80:e}set clusterRadius(e){this.setAttribute("cluster-radius",String(e))}get data(){const e=this.querySelectorAll("dm-marker[properties]");return e.length===0?null:{type:"FeatureCollection",features:Array.from(e).map(n=>{const s=n.center;return{type:"Feature",properties:{label:n.label,...n.properties},geometry:s?{type:"Point",coordinates:[s[1],s[0]]}:null}})}}show(){ni(this,this.layerGroup,this.#t,"dm-layer")}hide(){ri(this,this.layerGroup,"dm-layer")}toggle(){this.hidden?this.show():this.hide()}connectedCallback(){const e=this.closest("dm-map");e&&(!this.id&&(this.filterProperty||this.filterProperties)&&(this.id=`dm-layer-${Math.random().toString(36).slice(2,9)}`),e.map?this.#a(e.map):e.addEventListener("dm-map:ready",n=>{this.#a(n.detail.map)},{once:!0}),this.#n=this.#e.bind(this),this.addEventListener("dm-filter:apply",this.#n))}#e(e){this.querySelectorAll("dm-geojson[filter-property], dm-geojson[filter-properties], dm-wfs[filter-property], dm-wfs[filter-properties]").forEach(a=>{a.dispatchEvent(new CustomEvent("dm-filter:apply",{bubbles:!1,detail:e.detail}))});const s=e.detail.filters;this.querySelectorAll("dm-marker").forEach(a=>{const l=a.properties;this.#i(l,s)?a.show():a.hide()})}#i(e,n){return!n||Object.keys(n).length===0?!0:e?Pe([{properties:e}],n).length>0:!1}#a(e){this.#t=e,this.cluster&&G.markerClusterGroup?this.layerGroup=G.markerClusterGroup({maxClusterRadius:this.clusterRadius,disableClusteringAtZoom:this.clusterMaxZoom+1,spiderfyOnMaxZoom:!0,showCoverageOnHover:!1,zoomToBoundsOnClick:!0}).addTo(e):this.layerGroup=G.layerGroup().addTo(e),this.dispatchEvent(new CustomEvent("dm-layer:ready",{bubbles:!0,composed:!0,detail:{layerGroup:this.layerGroup,map:this.#t}}))}attributeChangedCallback(e,n,s){n===s||!this.layerGroup||e==="hidden"&&(s!==null?this.hide():this.show())}disconnectedCallback(){this.#n&&(this.removeEventListener("dm-filter:apply",this.#n),this.#n=null),this.layerGroup&&this.#t&&(this.layerGroup.remove(),this.layerGroup=null,this.#t=null)}}customElements.define("dm-layer",Kd);function Ln(i){try{const e=new URL(i,window.location.origin);return e.protocol==="http:"||e.protocol==="https:"||e.protocol==="blob:"}catch{return!1}}const Xd=["application/json","application/geo+json","application/vnd.geo+json","text/plain","text/xml","application/xml","application/gml+xml","image/png","image/jpeg","image/svg+xml"];function Cn(i){const n=(i.headers.get("content-type")||"").split(";")[0].trim().toLowerCase();if(!Xd.includes(n))throw new Error(`Unexpected content type: ${n}`)}async function*_s(i,e={}){const{batchSize:n=100,onProgress:s=null,signal:a=null,crsTransformer:l=null}=e;try{const h=(await i.json()).features||[],c=h.length;if(a?.aborted)throw new DOMException("Aborted","AbortError");for(let u=0;u<c;u+=n){if(a?.aborted)throw new DOMException("Aborted","AbortError");const m=h.slice(u,Math.min(u+n,c)),v=u+m.length,_={loaded:v,total:c,percent:Math.round(v/c*100),featuresRendered:v};s&&s(_),yield{features:m,progress:_}}}catch(h){throw h}}class Fi extends HTMLElement{#t=null;#n=null;#e=null;#i=null;#a=null;#o=null;#r=!1;#s=null;#l=null;#h=null;#d={};#f=null;#c=null;#u=null;get#p(){const e=getComputedStyle(this),n=e.getPropertyValue("--draad-map-components-geojson-color").trim()||"#555",s=e.getPropertyValue("--draad-map-components-geojson-fill-color").trim()||n,a=parseFloat(e.getPropertyValue("--draad-map-components-geojson-fill-opacity"))||.15,l=parseFloat(e.getPropertyValue("--draad-map-components-geojson-opacity"))||.8,h=parseInt(e.getPropertyValue("--draad-map-components-geojson-weight"))||2,c=e.getPropertyValue("--draad-map-components-geojson-dash-array").trim()||"6 4";return{color:n,weight:h,dashArray:c,fillColor:s,fillOpacity:a,opacity:l}}get#g(){return{dashArray:null,opacity:1}}static#v="data:image/svg+xml,"+encodeURIComponent('<svg xmlns="http://www.w3.org/2000/svg" width="25" height="41" viewBox="0 0 25 41"><path fill="#555" stroke="#333" stroke-width="2" d="M12.5 1C6.15 1 1 6.15 1 12.5c0 9.38 11.5 27.5 11.5 27.5S24 21.88 24 12.5C24 6.15 18.85 1 12.5 1z"/><circle fill="#fff" cx="12.5" cy="12.5" r="5"/></svg>');static get observedAttributes(){return["src","crs","label","hidden","filter-property","filter-label","filter-properties","filter-labels","infowindow-properties","infowindow-labels","streaming","batch-size","icon","icon-hover","icon-active"]}get src(){return this.getAttribute("src")}set src(e){this.setAttribute("src",e)}get crs(){return this.getAttribute("crs")}set crs(e){this.setAttribute("crs",e)}get geoJsonLayer(){return this.#e}get data(){return this.#i}get label(){return this.getAttribute("label")}set label(e){this.setAttribute("label",e)}get hidden(){return this.hasAttribute("hidden")}set hidden(e){e?this.setAttribute("hidden",""):this.removeAttribute("hidden")}get filterProperty(){return this.getAttribute("filter-property")}set filterProperty(e){this.setAttribute("filter-property",e)}get filterLabel(){return this.getAttribute("filter-label")}set filterLabel(e){this.setAttribute("filter-label",e)}get filterProperties(){return this.getAttribute("filter-properties")}set filterProperties(e){this.setAttribute("filter-properties",e)}get filterLabels(){return this.getAttribute("filter-labels")}set filterLabels(e){this.setAttribute("filter-labels",e)}get infowindowProperties(){return this.getAttribute("infowindow-properties")}set infowindowProperties(e){this.setAttribute("infowindow-properties",e)}get infowindowLabels(){return this.getAttribute("infowindow-labels")}set infowindowLabels(e){this.setAttribute("infowindow-labels",e)}get streaming(){return this.hasAttribute("streaming")}set streaming(e){e?this.setAttribute("streaming",""):this.removeAttribute("streaming")}get batchSize(){const e=parseInt(this.getAttribute("batch-size"));return isNaN(e)||e<1||e>1e4?100:e}set batchSize(e){this.setAttribute("batch-size",String(e))}get cluster(){return this.hasAttribute("cluster")}set cluster(e){e?this.setAttribute("cluster",""):this.removeAttribute("cluster")}get clusterMaxZoom(){const e=parseInt(this.getAttribute("cluster-max-zoom"));return isNaN(e)||e<0||e>22?null:e}set clusterMaxZoom(e){this.setAttribute("cluster-max-zoom",String(e))}get clusterRadius(){const e=parseInt(this.getAttribute("cluster-radius"));return isNaN(e)||e<=0?80:e}set clusterRadius(e){this.setAttribute("cluster-radius",String(e))}get isStreaming(){return this.#r}get loadProgress(){return this.#s}setPointToLayer(e){this.#f=e}show(){const e=this.#n||this.#t;ni(this,this.#e,e,"dm-geojson")}hide(){ri(this,this.#e,"dm-geojson")}toggle(){this.hidden?this.show():this.hide()}connectedCallback(){const e=this.closest("dm-layer"),n=this.closest("dm-map");e?e.layerGroup?this.#b(e.layerGroup,n.map):e.addEventListener("dm-layer:ready",s=>{this.#b(s.detail.layerGroup,s.detail.map)},{once:!0}):n&&(n.map?this.#b(null,n.map):n.addEventListener("dm-map:ready",s=>{this.#b(null,s.detail.map)},{once:!0})),this.#a=this.#w.bind(this),this.addEventListener("dm-filter:apply",this.#a),this.addEventListener("dm-geojson:feature-click",s=>{const a=s.detail?.layer?.feature?s.detail.layer:this.#k(s.detail?.feature);this.#m(a)})}#k(e){if(!e)return null;let n=null;const s=a=>{a?.eachLayer?.(l=>{n||(l.feature===e?n=l:l.eachLayer&&s(l))})};return s(this.#e),n||s(this.#h),n}#m(e){!e||e===this.#u||(this.clearActiveFeature(),e.setIcon&&this.#d.active?(e._dmActive=!0,e.setIcon(this.#d.active),e.setZIndexOffset?.(1e3)):e.setStyle&&(e.setStyle(this.#g),e.bringToFront?.()),this.#u=e)}clearActiveFeature(){const e=this.#u;e&&(e.setIcon?(e._dmActive=!1,e.setIcon(e._dmCustomIcon||this.#d.default),e.setZIndexOffset?.(0)):e.setStyle&&e.setStyle(this.#p),this.#u=null)}#w(e){this.#l=e.detail.filters,this.#z(e.detail.filters)}#P(e){return e?new Promise(n=>{const s=new Image;s.onload=()=>{const a=30/s.naturalWidth,l=Math.round(s.naturalWidth*a),h=Math.round(s.naturalHeight*a);n(G.icon({iconUrl:e,iconSize:[l,h],iconAnchor:[Math.round(l/2),h],popupAnchor:[0,-h]}))},s.onerror=()=>n(G.icon({iconUrl:Fi.#v,iconSize:[25,41],iconAnchor:[12,41],popupAnchor:[0,-41]})),s.src=e}):Promise.resolve(G.icon({iconUrl:Fi.#v,iconSize:[25,41],iconAnchor:[12,41],popupAnchor:[0,-41]}))}async#E(){const e=window.__DRAAD_MAPS_BASE__||"",n=this.getAttribute("icon")||(e?`${e}/markers/marker.png`:null),s=this.getAttribute("icon-hover")||(e?`${e}/markers/marker-hover.png`:null),a=this.getAttribute("icon-active")||(e?`${e}/markers/marker-active.png`:null),[l,h,c]=await Promise.all([this.#P(n),this.#P(s),this.#P(a)]);this.#d={default:l,hover:h,active:c}}#x(e,n){if(this.#f)return this.#f(e,n);const s=G.marker(n,{icon:this.#d.default});return s.on("mouseover",()=>s.setIcon(this.#d.hover)),s.on("mouseout",()=>{s.setIcon(s._dmActive?this.#d.active:s._dmCustomIcon||this.#d.default)}),s}#A(){const e={maxClusterRadius:this.clusterRadius,spiderfyOnMaxZoom:!0,showCoverageOnHover:!1,zoomToBoundsOnClick:!0};this.clusterMaxZoom!==null&&(e.disableClusteringAtZoom=this.clusterMaxZoom+1);const n=G.markerClusterGroup(e);return n.on("clusterclick",s=>{this.dispatchEvent(new CustomEvent("dm-geojson:cluster-click",{bubbles:!0,composed:!0,detail:{cluster:s.layer,latlng:s.latlng,childCount:s.layer.getChildCount()}}))}),n}#L(e){return e?(e.features||(e.type==="Feature"?[e]:[])).some(s=>s.geometry?.type==="Point"||s.geometry?.type==="MultiPoint"):!1}async#C(){this.#r=!0,this.#s={loaded:0,total:null,percent:null,featuresRendered:0},this.#o=new AbortController;const e=this.#o;await this.#E(),this.#e=G.geoJSON(null);const n=this.#n||this.#t;this.#e.addTo(n),this.#i={type:"FeatureCollection",features:[]};try{const s=await fetch(this.src,{signal:this.#o.signal});if(!s.ok)throw new Error(`HTTP ${s.status}: ${s.statusText}`);const a=this.#y(this.crs,null);if(!a){this.dispatchEvent(new CustomEvent("dm-geojson:error",{bubbles:!0,composed:!0,detail:{error:new Error("Could not determine coordinate system. Add a crs attribute.")}}));return}let l=!0;for await(const{features:h}of _s(s,{batchSize:this.batchSize,onProgress:c=>{this.#s=c,this.dispatchEvent(new CustomEvent("dm-geojson:progress",{detail:c,bubbles:!0,composed:!0}))},signal:this.#o.signal,crsTransformer:a})){if(e!==this.#o)return;this.#i.features.push(...h);const c=this.#l?Pe(h,this.#l):h;c.length>0&&(await this.#_(c),l&&(this.dispatchEvent(new CustomEvent("dm-geojson:first-feature",{detail:{feature:c[0],layer:this.#e},bubbles:!0,composed:!0})),l=!1)),this.#s.featuresRendered=this.#i.features.length}e===this.#o&&(this.#r=!1),Ee(this,this.#e),this.dispatchEvent(new CustomEvent("dm-geojson:ready",{bubbles:!0,composed:!0,detail:{layer:this.#e,data:this.#i}}))}catch(s){if(e===this.#o&&(this.#r=!1),s.name==="AbortError")return;this.dispatchEvent(new CustomEvent("dm-geojson:error",{bubbles:!0,composed:!0,detail:{error:s}}))}}async#_(e){return new Promise(n=>{requestAnimationFrame(()=>{const s={type:"FeatureCollection",features:e},a=this.#y(this.crs,null);G.geoJSON(s,{coordsToLatLng:a,style:()=>({...this.#p}),pointToLayer:(l,h)=>this.#x(l,h),onEachFeature:(l,h)=>{h.setStyle&&(h.on("mouseover",()=>h.setStyle(this.#g)),h.on("mouseout",()=>h.setStyle(h._dmActive?this.#g:this.#p))),h.on("click",c=>{this.dispatchEvent(new CustomEvent("dm-geojson:feature-click",{bubbles:!0,composed:!0,detail:{feature:l,layer:h,latlng:c.latlng}}))}),this.#e.addLayer(h)}}),n()})})}#M(){this.#o&&(this.#o.abort(),this.#o=null,this.#r=!1)}async#b(e,n){this.#c&&await this.#c;let s;this.#c=new Promise(a=>s=a);try{this.#t=n,this.#n=e;const a=this.src;if(!a)return;if(!Ln(a))throw new Error("Invalid URL: must be http or https");if(this.streaming){await this.#C();return}const l=await fetch(a);if(!l.ok)throw new Error(`HTTP ${l.status}: ${l.statusText}`);Cn(l);const h=await l.json();this.#i=h;const c=this.#y(this.crs,h);if(!c){this.dispatchEvent(new CustomEvent("dm-geojson:error",{bubbles:!0,composed:!0,detail:{error:new Error("Could not determine coordinate system. Add a crs attribute.")}}));return}await this.#E();const u={coordsToLatLng:c,style:()=>({...this.#p}),pointToLayer:(v,_)=>this.#x(v,_),onEachFeature:(v,_)=>{_.setStyle&&(_.on("mouseover",()=>_.setStyle(this.#g)),_.on("mouseout",()=>_.setStyle(_._dmActive?this.#g:this.#p))),_.on("click",g=>{this.dispatchEvent(new CustomEvent("dm-geojson:feature-click",{bubbles:!0,composed:!0,detail:{feature:v,layer:_,latlng:g.latlng}}))})}},m=e&&typeof e.getMaxZoom=="function"?n:e||n;if(this.cluster&&G.markerClusterGroup&&this.#L(h)){const v={type:"FeatureCollection",features:[]},_={type:"FeatureCollection",features:[]};for(const w of h.features||[])w.geometry?.type==="Point"||w.geometry?.type==="MultiPoint"?v.features.push(w):_.features.push(w);this.#h=this.#A(),this.#h.addTo(m);const g=[];G.geoJSON(v,u).eachLayer(w=>g.push(w)),this.#h.addLayers(g),_.features.length>0?(this.#e=G.geoJSON(_,u),this.#e.addTo(m)):this.#e=this.#h}else this.#e=G.geoJSON(h,u),this.#e.addTo(m);Ee(this,this.#e),this.dispatchEvent(new CustomEvent("dm-geojson:ready",{bubbles:!0,composed:!0,detail:{layer:this.#e,data:this.#i}}))}catch(a){this.dispatchEvent(new CustomEvent("dm-geojson:error",{bubbles:!0,composed:!0,detail:{error:a}}))}finally{s(),this.#c=null}}#y(e,n){const s=he(e);return s?s==="EPSG:4326"?a=>G.latLng(a[1],a[0]):a=>{const[l,h]=ii(a,s);return G.latLng(h,l)}:Ri(n)?null:a=>G.latLng(a[1],a[0])}attributeChangedCallback(e,n,s){n===s||!this.#t||this.#I(e,s)}async#I(e,n){switch(e){case"src":case"crs":await this.#T();break;case"hidden":n!==null?this.hide():this.show();break;case"icon":case"icon-hover":case"icon-active":await this.#E(),await this.#T();break}}async#T(){this.#M(),this.#h&&this.#h!==this.#e&&this.#h.remove(),this.#h=null,this.#e&&(this.#e.remove(),this.#e=null),this.#i=null,this.#s=null,await this.#b(this.#n,this.#t)}async#z(e){if(!this.#e||!this.#i)return;if(this.#r){this.#M(),await this.#T();return}const n={coordsToLatLng:this.#y(this.crs,this.#i),style:()=>({...this.#p}),pointToLayer:(a,l)=>this.#x(a,l),onEachFeature:(a,l)=>{l.setStyle&&(l.on("mouseover",()=>l.setStyle(this.#g)),l.on("mouseout",()=>l.setStyle(l._dmActive?this.#g:this.#p))),l.on("click",h=>{this.dispatchEvent(new CustomEvent("dm-geojson:feature-click",{bubbles:!0,composed:!0,detail:{feature:a,layer:l,latlng:h.latlng}}))})}},s=!e||Object.keys(e).length===0?this.#i:{type:"FeatureCollection",features:Pe(this.#i.features,e)};if(this.#h){const a={type:"FeatureCollection",features:[]},l={type:"FeatureCollection",features:[]};for(const c of s.features||[])c.geometry?.type==="Point"||c.geometry?.type==="MultiPoint"?a.features.push(c):l.features.push(c);this.#h.clearLayers();const h=[];if(G.geoJSON(a,n).eachLayer(c=>h.push(c)),this.#h.addLayers(h),this.#e!==this.#h){this.#e.clearLayers();const c=[];G.geoJSON(l,n).eachLayer(u=>c.push(u)),c.forEach(u=>this.#e.addLayer(u))}}else{this.#e.clearLayers();const a=[];G.geoJSON(s,n).eachLayer(l=>a.push(l)),a.forEach(l=>this.#e.addLayer(l))}this.dispatchEvent(new CustomEvent("dm-geojson:updated",{bubbles:!0,composed:!0,detail:{layer:this.#e,data:s}}))}disconnectedCallback(){this.#M(),this.#a&&(this.removeEventListener("dm-filter:apply",this.#a),this.#a=null),this.#h&&this.#h!==this.#e&&this.#h.remove(),this.#h=null,this.#e&&(this.#e.remove(),this.#e=null),this.#t=null,this.#n=null,this.#i=null,this.#s=null,this.#l=null,this.#f=null}}customElements.define("dm-geojson",Fi);function gs(i,e){if(!e)return i;const n=encodeURIComponent(i);if(e.includes("{url}"))return e.replace("{url}",n);const s=e.slice(-1),a=s==="?"||s==="&"?"":e.includes("?")?"&":"?";return`${e}${a}url=${n}`}class mt extends HTMLElement{#t=null;#n=null;#e=null;#i=null;#a=null;#o=null;#r=null;#s={};#l=null;#h=!1;#d=null;#f=null;static#c={color:"#555",weight:2,dashArray:"6 4",fillColor:"#555",fillOpacity:.15,opacity:.8};static#u={dashArray:null,opacity:1};static get observedAttributes(){return["src","name","version","format","crs","max-features","proxy","label","hidden","filter-property","filter-label","filter-properties","filter-labels","infowindow-properties","infowindow-labels","streaming","batch-size","cache-ttl","bbox-filter"]}get src(){return this.getAttribute("src")}set src(e){this.setAttribute("src",e)}get name(){return this.getAttribute("name")}set name(e){this.setAttribute("name",e)}get version(){return this.getAttribute("version")||"1.1.0"}set version(e){this.setAttribute("version",e)}get format(){return this.getAttribute("format")||"application/json"}set format(e){this.setAttribute("format",e)}get crs(){return this.getAttribute("crs")}set crs(e){this.setAttribute("crs",e)}get proxy(){return this.getAttribute("proxy")}set proxy(e){this.setAttribute("proxy",e)}get wfsLayer(){return this.#e}get data(){return this.#i}get label(){return this.getAttribute("label")}set label(e){this.setAttribute("label",e)}get hidden(){return this.hasAttribute("hidden")}set hidden(e){e?this.setAttribute("hidden",""):this.removeAttribute("hidden")}get filterProperty(){return this.getAttribute("filter-property")}set filterProperty(e){this.setAttribute("filter-property",e)}get filterLabel(){return this.getAttribute("filter-label")}set filterLabel(e){this.setAttribute("filter-label",e)}get filterProperties(){return this.getAttribute("filter-properties")}set filterProperties(e){this.setAttribute("filter-properties",e)}get filterLabels(){return this.getAttribute("filter-labels")}set filterLabels(e){this.setAttribute("filter-labels",e)}get infowindowProperties(){return this.getAttribute("infowindow-properties")}set infowindowProperties(e){this.setAttribute("infowindow-properties",e)}get infowindowLabels(){return this.getAttribute("infowindow-labels")}set infowindowLabels(e){this.setAttribute("infowindow-labels",e)}get streaming(){return this.hasAttribute("streaming")}set streaming(e){e?this.setAttribute("streaming",""):this.removeAttribute("streaming")}get batchSize(){const e=parseInt(this.getAttribute("batch-size"));return isNaN(e)||e<1||e>1e4?100:e}set batchSize(e){this.setAttribute("batch-size",String(e))}get cluster(){return this.hasAttribute("cluster")}set cluster(e){e?this.setAttribute("cluster",""):this.removeAttribute("cluster")}get clusterMaxZoom(){const e=parseInt(this.getAttribute("cluster-max-zoom"));return isNaN(e)||e<0||e>22?null:e}set clusterMaxZoom(e){this.setAttribute("cluster-max-zoom",String(e))}get clusterRadius(){const e=parseInt(this.getAttribute("cluster-radius"));return isNaN(e)||e<=0?80:e}set clusterRadius(e){this.setAttribute("cluster-radius",String(e))}get cacheTtl(){const e=parseInt(this.getAttribute("cache-ttl"));return isNaN(e)?300:e}set cacheTtl(e){this.setAttribute("cache-ttl",String(e))}get bboxFilter(){return this.hasAttribute("bbox-filter")}set bboxFilter(e){e?this.setAttribute("bbox-filter",""):this.removeAttribute("bbox-filter")}get isStreaming(){return this.#h}get loadProgress(){return this.#d}show(){const e=this.#n||this.#t;ni(this,this.#e,e,"dm-wfs")}hide(){ri(this,this.#e,"dm-wfs")}toggle(){this.hidden?this.show():this.hide()}refresh(){return this.#b()}getFeatures(){return this.#i?[...this.#i.features||[]]:[]}cancelRequest(){this.#m()}connectedCallback(){const e=this.closest("dm-layer"),n=this.closest("dm-map");e?e.layerGroup?this.#_(e.layerGroup,n.map):e.addEventListener("dm-layer:ready",s=>{this.#_(s.detail.layerGroup,s.detail.map)},{once:!0}):n&&(n.map?this.#_(null,n.map):n.addEventListener("dm-map:ready",s=>{this.#_(null,s.detail.map)},{once:!0})),this.#a=this.#v.bind(this),this.addEventListener("dm-filter:apply",this.#a),this.addEventListener("dm-wfs:feature-click",s=>{const a=s.detail?.layer?.feature?s.detail.layer:this.#p(s.detail?.feature);this.#g(a)})}#p(e){if(!e)return null;let n=null;const s=a=>{a?.eachLayer?.(l=>{n||(l.feature===e?n=l:l.eachLayer&&s(l))})};return s(this.#e),n||s(this.#r),n}#g(e){!e||e===this.#o||(this.clearActiveFeature(),e.setIcon&&this.#s.active?(e._dmActive=!0,e.setIcon(this.#s.active),e.setZIndexOffset?.(1e3)):e.setStyle&&(e.setStyle(mt.#u),e.bringToFront?.()),this.#o=e)}clearActiveFeature(){const e=this.#o;e&&(e.setIcon?(e._dmActive=!1,e.setIcon(e._dmCustomIcon||this.#s.default),e.setZIndexOffset?.(0)):e.setStyle&&e.setStyle(mt.#c),this.#o=null)}#v(e){this.#f=e.detail.filters,this.#y(e.detail.filters)}#k(){const e=new URL(this.src,window.location.origin),n=e.searchParams,s=this.version;n.set("service","WFS"),n.set("version",s),n.set("request","GetFeature");const a=s==="2.0.0"?"typeNames":"typeName";n.set(a,this.name),n.set("outputFormat",this.format);const l=this.crs;l&&n.set("srsName",he(l));const h=this.getAttribute("max-features");if(h){const u=s==="2.0.0"?"count":"maxFeatures";n.set(u,h)}const c=e.toString();return gs(c,this.proxy)}#m(){this.#l&&(this.#l.abort(),this.#l=null)}#w(e){return e?(e.features||(e.type==="Feature"?[e]:[])).some(s=>s.geometry?.type==="Point"||s.geometry?.type==="MultiPoint"):!1}#P(){const e={maxClusterRadius:this.clusterRadius,spiderfyOnMaxZoom:!0,showCoverageOnHover:!1,zoomToBoundsOnClick:!0},n=this.clusterMaxZoom;n!==null&&(e.disableClusteringAtZoom=n+1);const s=G.markerClusterGroup(e);return s.on("clusterclick",a=>{this.dispatchEvent(new CustomEvent("dm-wfs:cluster-click",{bubbles:!0,composed:!0,detail:{cluster:a.layer,latlng:a.latlng,childCount:a.layer.getChildCount()}}))}),s}#E(e){return e?e==="EPSG:4326"?n=>G.latLng(n[1],n[0]):n=>{const[s,a]=ii(n,e);return G.latLng(a,s)}:n=>G.latLng(n[1],n[0])}#x(e,n){let s=he(e);return s||(s=ls(n)),s?s==="EPSG:4326"?a=>G.latLng(a[1],a[0]):a=>{const[l,h]=ii(a,s);return G.latLng(h,l)}:Ri(n)?null:a=>G.latLng(a[1],a[0])}#A(e){return n=>{this.dispatchEvent(new CustomEvent("dm-wfs:feature-click",{bubbles:!0,composed:!0,detail:{feature:e,layer:n.target,latlng:n.latlng}}))}}async#L(e,n){return new Promise(s=>{requestAnimationFrame(()=>{const a={type:"FeatureCollection",features:e};G.geoJSON(a,{coordsToLatLng:n,style:()=>({...mt.#c}),onEachFeature:(l,h)=>{h.setStyle&&(h.on("mouseover",()=>h.setStyle(mt.#u)),h.on("mouseout",()=>h.setStyle(h._dmActive?mt.#u:mt.#c))),h.on("click",c=>{this.dispatchEvent(new CustomEvent("dm-wfs:feature-click",{bubbles:!0,composed:!0,detail:{feature:l,layer:h,latlng:c.latlng}}))}),this.#e.addLayer(h)}}),s()})})}async#C(){this.#h=!0,this.#d={loaded:0,total:null,percent:null,featuresRendered:0},this.#l=new AbortController,this.#e=G.geoJSON(null);const e=this.#n||this.#t;this.#e.addTo(e),this.#i={type:"FeatureCollection",features:[]};const n=this.#k();try{if(!Ln(n))throw new Error("Invalid URL: must be http or https");const s=await fetch(n);if(!s.ok)throw new Error(`HTTP ${s.status}: ${s.statusText}`);Cn(s);let a=he(this.crs),l=s;if(!a){const u=await s.json();a=ls(u),l=new Response(JSON.stringify(u),{headers:s.headers})}const h=this.#E(a);if(!h){this.dispatchEvent(new CustomEvent("dm-wfs:error",{bubbles:!0,composed:!0,detail:{error:new Error("Could not determine coordinate system. Add a crs attribute.")}}));return}let c=!0;for await(const u of _s(l,{batchSize:this.batchSize,onProgress:m=>{this.#d=m,this.dispatchEvent(new CustomEvent("dm-wfs:progress",{bubbles:!0,composed:!0,detail:m}))},signal:this.#l.signal,crsTransformer:h})){this.#i.features.push(...u.features);const m=this.#f?Pe(u.features,this.#f):u.features;m.length>0&&(await this.#L(m,h),c&&(this.dispatchEvent(new CustomEvent("dm-wfs:first-feature",{bubbles:!0,composed:!0,detail:{feature:m[0],layer:this.#e}})),c=!1)),this.#d&&(this.#d.featuresRendered=this.#i.features.length)}this.#h=!1,Ee(this,this.#e),this.dispatchEvent(new CustomEvent("dm-wfs:ready",{bubbles:!0,composed:!0,detail:{layer:this.#e,data:this.#i}}))}catch(s){if(this.#h=!1,s.name==="AbortError")return;this.dispatchEvent(new CustomEvent("dm-wfs:error",{bubbles:!0,composed:!0,detail:{error:s}}))}}async#_(e,n){if(this.#t=n,this.#n=e,!this.src||!this.name)return;if(this.streaming){await this.#C();return}const s=this.#k();try{if(!Ln(s))throw new Error("Invalid URL: must be http or https");const a=await fetch(s);if(!a.ok)throw new Error(`HTTP ${a.status}: ${a.statusText}`);Cn(a);const l=await a.json();this.#i=l;const h=this.#x(this.crs,l);if(!h){this.dispatchEvent(new CustomEvent("dm-wfs:error",{bubbles:!0,composed:!0,detail:{error:new Error("Could not determine coordinate system. Add a crs attribute.")}}));return}const c=(m,v)=>{v.setStyle&&(v.on("mouseover",()=>v.setStyle(mt.#u)),v.on("mouseout",()=>v.setStyle(v._dmActive?mt.#u:mt.#c))),v.on("click",_=>{this.dispatchEvent(new CustomEvent("dm-wfs:feature-click",{bubbles:!0,composed:!0,detail:{feature:m,layer:v,latlng:_.latlng}}))})},u=e&&typeof e.getMaxZoom=="function"?n:e||n;if(this.cluster&&G.markerClusterGroup&&this.#w(l)){const m={type:"FeatureCollection",features:[]},v={type:"FeatureCollection",features:[]};for(const g of l.features||[])g.geometry?.type==="Point"||g.geometry?.type==="MultiPoint"?m.features.push(g):v.features.push(g);this.#r=this.#P(),this.#r.addTo(u);const _=[];G.geoJSON(m,{coordsToLatLng:h,onEachFeature:c}).eachLayer(g=>_.push(g)),this.#r.addLayers(_),v.features.length>0?(this.#e=G.geoJSON(v,{coordsToLatLng:h,style:()=>({...mt.#c}),onEachFeature:c}),this.#e.addTo(u)):this.#e=this.#r}else this.#e=G.geoJSON(l,{coordsToLatLng:h,style:()=>({...mt.#c}),onEachFeature:c}),this.#e.addTo(u);Ee(this,this.#e),this.dispatchEvent(new CustomEvent("dm-wfs:ready",{bubbles:!0,composed:!0,detail:{layer:this.#e,data:this.#i}}))}catch(a){this.dispatchEvent(new CustomEvent("dm-wfs:error",{bubbles:!0,composed:!0,detail:{error:a}}))}}attributeChangedCallback(e,n,s){n===s||!this.#t||this.#M(e,s)}#M(e,n){switch(e){case"src":case"name":case"version":case"format":case"crs":case"max-features":case"proxy":this.#b();break;case"hidden":n!==null?this.hide():this.show();break}}async#b(){this.#m(),this.#r&&this.#r!==this.#e&&this.#r.remove(),this.#r=null,this.#e&&(this.#e.remove(),this.#e=null),this.#i=null,this.#d=null,await this.#_(this.#n,this.#t)}async#y(e){if(!this.#e||!this.#i)return;if(this.#h){this.#m(),await this.#b();return}const n=this.#x(this.crs,this.#i),s=(h,c)=>{c.setStyle&&(c.on("mouseover",()=>c.setStyle(mt.#u)),c.on("mouseout",()=>c.setStyle(c._dmActive?mt.#u:mt.#c))),c.on("click",u=>{this.dispatchEvent(new CustomEvent("dm-wfs:feature-click",{bubbles:!0,composed:!0,detail:{feature:h,layer:c,latlng:u.latlng}}))})},a=()=>({...mt.#c});if(!e||Object.keys(e).length===0){this.#e.clearLayers(),G.geoJSON(this.#i,{coordsToLatLng:n,style:a,onEachFeature:s}).eachLayer(h=>this.#e.addLayer(h));return}this.#e.clearLayers();const l={type:"FeatureCollection",features:Pe(this.#i.features,e)};G.geoJSON(l,{coordsToLatLng:n,style:a,onEachFeature:s}).eachLayer(h=>this.#e.addLayer(h))}disconnectedCallback(){this.#m(),this.#a&&(this.removeEventListener("dm-filter:apply",this.#a),this.#a=null),this.#r&&this.#r!==this.#e&&this.#r.remove(),this.#r=null,this.#e&&(this.#e.remove(),this.#e=null),this.#t=null,this.#n=null,this.#i=null,this.#d=null,this.#f=null}}customElements.define("dm-wfs",mt);class Qd extends HTMLElement{#t=null;#n=null;#e=null;static get observedAttributes(){return["src","layers","version","format","transparent","styles","crs","proxy","opacity","min-zoom","max-zoom","label","hidden","time"]}get src(){return this.getAttribute("src")}set src(e){this.setAttribute("src",e)}get layers(){return this.getAttribute("layers")}set layers(e){this.setAttribute("layers",e)}get version(){return this.getAttribute("version")||"1.1.1"}set version(e){this.setAttribute("version",e)}get format(){return this.getAttribute("format")||"image/png"}set format(e){this.setAttribute("format",e)}get transparent(){const e=this.getAttribute("transparent");return e===null||e==="true"}set transparent(e){this.setAttribute("transparent",String(e))}get styles(){return this.getAttribute("styles")||""}set styles(e){this.setAttribute("styles",e)}get crs(){return this.getAttribute("crs")}set crs(e){this.setAttribute("crs",e)}get proxy(){return this.getAttribute("proxy")}set proxy(e){this.setAttribute("proxy",e)}get opacity(){const e=this.getAttribute("opacity");return e?parseFloat(e):1}set opacity(e){this.setAttribute("opacity",String(e))}get time(){return this.getAttribute("time")}set time(e){this.setAttribute("time",e)}get wmsLayer(){return this.#e}get label(){return this.getAttribute("label")}set label(e){this.setAttribute("label",e)}setOpacity(e){this.#e&&this.#e.setOpacity(e),this.setAttribute("opacity",String(e))}setTime(e){const n=this.time;this.setAttribute("time",e),this.refresh(),this.dispatchEvent(new CustomEvent("dm-wms:time-change",{bubbles:!0,composed:!0,detail:{time:e,previousTime:n}}))}refresh(){this.#e&&(this.#e.remove(),this.#e=null),this.#i(this.#n,this.#t)}show(){const e=this.#n||this.#t;this.removeAttribute("hidden"),ni(this,this.#e,e,"dm-wms")}hide(){this.setAttribute("hidden",""),ri(this,this.#e,"dm-wms")}toggle(){this.hidden?this.show():this.hide()}connectedCallback(){const e=this.closest("dm-layer"),n=this.closest("dm-map");e?e.layerGroup?this.#i(e.layerGroup,n.map):e.addEventListener("dm-layer:ready",s=>{this.#i(s.detail.layerGroup,s.detail.map)},{once:!0}):n&&(n.map?this.#i(null,n.map):n.addEventListener("dm-map:ready",s=>{this.#i(null,s.detail.map)},{once:!0}))}#i(e,n){if(this.#t=n,this.#n=e,!this.src){this.#r(new Error("dm-wms requires a src attribute"));return}if(!this.layers){this.#r(new Error("dm-wms requires a layers attribute"));return}try{const s=this.#a(),a=this.#o();this.#e=G.tileLayer.wms(s,a),e?this.#e.addTo(e):this.#e.addTo(n),Ee(this,this.#e),this.dispatchEvent(new CustomEvent("dm-wms:ready",{bubbles:!0,composed:!0,detail:{layer:this.#e}}))}catch(s){this.#r(s)}}#a(){let e=this.src;return e=e.replace(/\?+$/,""),gs(e,this.proxy)}#o(){const e={layers:this.layers,format:this.format,transparent:this.transparent,version:this.version,styles:this.styles,opacity:this.opacity,attribution:'&copy; <a href="https://www.kadaster.nl">Kadaster</a>'},n=this.crs;n&&(e.crs=he(n));const s=this.getAttribute("min-zoom"),a=this.getAttribute("max-zoom");s&&(e.minZoom=parseInt(s,10)),a&&(e.maxZoom=parseInt(a,10));const l=this.time;return l&&(e.TIME=l),e}#r(e){this.dispatchEvent(new CustomEvent("dm-wms:error",{bubbles:!0,composed:!0,detail:{error:e}}))}attributeChangedCallback(e,n,s){if(!(n===s||!this.#e))switch(e){case"opacity":{const a=parseFloat(s);isNaN(a)||this.#e.setOpacity(a);break}case"hidden":this.hasAttribute("hidden")?this.hide():this.show();break;case"time":this.#s();break;case"src":case"layers":case"version":case"format":case"transparent":case"styles":case"crs":case"proxy":case"min-zoom":case"max-zoom":this.#s();break}}#s(){this.#e&&(this.#e.remove(),this.#e=null),this.#i(this.#n,this.#t)}disconnectedCallback(){this.#e&&(this.#e.remove(),this.#e=null),this.#t=null,this.#n=null}}customElements.define("dm-wms",Qd);const Yd=`:host {
	display: block;
...
`;class tu extends HTMLElement{#t;#n=null;#e;#i=null;#a=null;#o=null;#r=-1;#s=[];#l=null;#h=null;#d;#f;static get observedAttributes(){return["placeholder","label","search-properties","search-labels","radius","min-chars","debounce","address-filter"]}attributeChangedCallback(e,n,s){n!==s&&this.#n&&(this.#p(),Ut(this.#t),this.#g())}constructor(){super(),this.#t=this.attachShadow({mode:"open"}),this.#d=`search-input-${Math.random().toString(36).slice(2,9)}`,this.#f=`search-listbox-${Math.random().toString(36).slice(2,9)}`,this.#e=this.#c()}#c(){const e=new CSSStyleSheet;e.replaceSync(Yd),this.#t.adoptedStyleSheets=[e]}get placeholder(){return this.getAttribute("placeholder")||"Zoeken..."}set placeholder(e){this.setAttribute("placeholder",e)}get label(){return this.getAttribute("label")||"Zoek op straat, wijk of stadsdeel"}set label(e){this.setAttribute("label",e)}get searchProperties(){const e=this.getAttribute("search-properties");return e?e.split(",").map(n=>n.trim()).filter(n=>n):null}set searchProperties(e){Array.isArray(e)?this.setAttribute("search-properties",e.join(",")):this.setAttribute("search-properties",e)}get searchLabels(){const e=this.getAttribute("search-labels");return e?e.split(",").map(n=>n.trim()).filter(n=>n):null}set searchLabels(e){Array.isArray(e)?this.setAttribute("search-labels",e.join(",")):this.setAttribute("search-labels",e)}get radius(){const e=this.getAttribute("radius"),n=parseInt(e,10);return Number.isFinite(n)&&n>0?n:1e4}set radius(e){this.setAttribute("radius",String(e))}get minChars(){const e=this.getAttribute("min-chars"),n=parseInt(e,10);return Number.isFinite(n)&&n>=0?n:2}set minChars(e){this.setAttribute("min-chars",String(e))}get debounceDelay(){const e=this.getAttribute("debounce"),n=parseInt(e,10);return Number.isFinite(n)&&n>=0?n:300}set debounceDelay(e){this.setAttribute("debounce",String(e))}get addressFilter(){const e=this.getAttribute("address-filter");return e&&e.trim()?e.trim():null}set addressFilter(e){this.setAttribute("address-filter",e)}connectedCallback(){const e=this.closest("dm-map");e&&(e.map?this.#u(e):e.addEventListener("dm-map:ready",()=>{this.#u(e)},{once:!0}))}async#u(e){this.#n=e,await this.#e,this.#p(),Ut(this.#t),this.#g()}#p(){this.#t.innerHTML=`
			<div class="search" part="root">
				<label for="${this.#d}" class="search__label" part="label">${this.#j(this.label)}</label>
				<div class="search__form" part="form" role="search">
					<div class="search__input-wrapper" part="input-wrapper">
						<input
							...
							class="search__input"
							part="input"
							placeholder="${this.#F(this.placeholder)}"
							maxlength="200"
							autocomplete="off"
							aria-autocomplete="list"
							aria-controls="${this.#f}"
							aria-expanded="false"
		...
		`}#g(){const e=this.#t.querySelector(".search__input"),n=this.#t.querySelector(".search__button"),s=this.#t.querySelector(".search__clear"),a=this.#t.querySelector(".search__listbox");e.addEventListener("input",l=>this.#v(l)),e.addEventListener("keydown",l=>this.#k(l)),e.addEventListener("focus",()=>this.#m()),e.addEventListener("blur",l=>this.#w(l)),n.addEventListener("click",()=>this.#P()),s.addEventListener("click",()=>{e.value="",s.hidden=!0,this.#s=[],this.#Z(),this.#U(),e.focus(),this.dispatchEvent(new CustomEvent("dm-search:clear",{bubbles:!0,composed:!0}))}),a.addEventListener("mousedown",l=>{l.preventDefault()}),a.addEventListener("click",l=>{const h=l.target.closest('[role="option"]');if(h){const c=parseInt(h.dataset.index,10);this.#D(c)}})}#v(e){const n=e.target.value.trim(),s=this.#t.querySelector(".search__clear");if(s&&(s.hidden=!e.target.value),this.#o&&(clearTimeout(this.#o),this.#o=null),this.#U(),n.length<this.minChars){this.#s=[],this.#Z();return}this.#o=setTimeout(()=>{this.#x(n)},this.debounceDelay)}#k(e){const s=!this.#t.querySelector(".search__listbox").hidden;switch(e.key){case"ArrowDown":e.preventDefault(),s&&this.#G(1);break;case"ArrowUp":e.preventDefault(),s&&this.#G(-1);break;case"Enter":if(e.preventDefault(),s&&this.#s.length>0){const a=this.#r>=0?this.#r:0;this.#D(a)}else this.#E();break;case"Escape":e.preventDefault(),this.#Z();break;case"Tab":this.#Z();break}}#m(){this.#s.length>0&&this.#J()}#w(e){this.#a=setTimeout(()=>{this.#Z()},150)}#P(){if(this.#s.length>0){const e=this.#r>=0?this.#r:0;this.#D(e)}else this.#E()}#E(){const n=this.#t.querySelector(".search__input").value.trim();n.length>=this.minChars&&this.#x(n)}async#x(e){this.#i&&this.#i.abort(),this.#i=new AbortController,this.#B(!0);try{const[n,s]=await Promise.all([this.#L(e),this.#A(e,this.#i.signal)]),a=s?.error===!0,l=a?s.results:s;this.#s=[...n.slice(0,5),...l.slice(0,10)],this.#N(a),this.#J();const h=this.#s.length;let c=h>0?`${h} resultaat${h!==1?"en":""} gevonden`:"Geen resultaten gevonden";a&&(c+=". Zoeken in adressen niet beschikbaar"),this.#$(c)}catch(n){n.name!=="AbortError"&&this.#$("Er is een fout opgetreden bij het zoeken")}finally{this.#B(!1)}}async#A(e,n){const s=new URL("https://api.pdok.nl/bzk/locatieserver/search/v3_1/free");s.searchParams.set("q",e),s.searchParams.set("rows","10"),s.searchParams.set("fq","type:(provincie OR gemeente OR woonplaats OR wijk OR buurt OR weg OR adres)"),this.addressFilter&&s.searchParams.append("fq",this.addressFilter),s.searchParams.set("fl","id,weergavenaam,type,score,centroide_ll,geometrie_ll");try{const a=await fetch(s.toString(),{signal:n});if(!a.ok)throw new Error(`HTTP ${a.status}`);return((await a.json()).response?.docs||[]).map(c=>({type:"address",label:c.weergavenaam,subtype:c.type,coordinates:this.#y(c.centroide_ll),geometry:c.geometrie_ll?this.#I(c.geometrie_ll):null,bounds:null,raw:c}))}catch(a){if(a.name==="AbortError")throw a;return{error:!0,results:[]}}}#L(e){const n=[],s=e.toLowerCase(),a=this.searchProperties,l=this.#n.querySelectorAll("dm-geojson, dm-wfs");for(const c of l){if(n.length>=5)break;const u=c.data;if(!u?.features)continue;const m=c.geoJsonLayer||c.wfsLayer;if(m)for(const v of u.features){if(n.length>=5)break;const _=v.properties||{},g=this.#C(_,s,a);if(g.length>0){const{label:w,matchedProperty:x}=this.#_(_,g);n.push({type:"feature",label:w,subtype:x,feature:v,layer:m,bounds:this.#M(v,m),coordinates:this.#b(v,m),source:c})}}}const h=this.#n.querySelectorAll("dm-marker[label]");for(const c of h){if(n.length>=5)break;const u=c.label;if(u&&u.toLowerCase().includes(s)){const m=c.center;if(!m)continue;n.push({type:"marker",label:u,subtype:"marker",coordinates:m,bounds:null,marker:c})}}return n}#C(e,n,s){const a=[];for(const[l,h]of Object.entries(e))s&&!s.includes(l)||typeof h=="string"&&h.toLowerCase().includes(n)&&a.push({key:l,value:h});return a}#_(e,n){const s=n[0],a=this.searchLabels,l=this.searchProperties;let h=s.key;if(l&&a){const c=l.indexOf(s.key);c>=0&&a[c]&&(h=a[c])}return{label:s.value,matchedProperty:h}}#M(e,n){const s=e.geometry;if(!s||s.type==="Point")return null;try{let l=null;if(n.eachLayer(h=>{h.feature===e&&(l=h)}),l&&l.getBounds)return l.getBounds()}catch{}return null}#b(e,n){const s=e.geometry;if(!s)return null;const a=s.type,l=s.coordinates;if(a==="Point")return[l[1],l[0]];try{let h=null;if(n.eachLayer(c=>{c.feature===e&&(h=c)}),h){if(h.getBounds){const c=h.getBounds().getCenter();return[c.lat,c.lng]}if(h.getLatLng){const c=h.getLatLng();return[c.lat,c.lng]}}}catch{}return null}#y(e){if(!e)return null;const n=e.match(/POINT\s*\(\s*([\d.-]+)\s+([\d.-]+)\s*\)/i);if(!n)return null;const s=parseFloat(n[1]),a=parseFloat(n[2]);return isNaN(a)||isNaN(s)?null:[a,s]}#I(e){if(!e)return null;const n=e.match(/^(\w+)/i);if(!n)return null;const s=n[1].toUpperCase();try{if(s==="POLYGON"||s==="MULTIPOLYGON")return this.#T(e,s);if(s==="LINESTRING"||s==="MULTILINESTRING")return this.#z(e,s);if(s==="POINT"){const a=this.#y(e);return a?{type:"Point",coordinates:[a[1],a[0]]}:null}}catch{}return null}#T(e,n){const s=[],a=/\(\s*([\d.\s,-]+)\s*\)/g;let l;for(;(l=a.exec(e))!==null;){const h=l[1].split(",").map(c=>{const[u,m]=c.trim().split(/\s+/).map(parseFloat);return[m,u]});h.length>0&&s.push(h)}return s.length===0?null:{type:n==="MULTIPOLYGON"?"MultiPolygon":"Polygon",coordinates:s}}#z(e,n){const s=[];if(n==="LINESTRING"){const a=e.match(/LINESTRING\s*\(\s*([\d.\s,-]+)\s*\)/i);if(a){const l=a[1].split(",").map(h=>{const[c,u]=h.trim().split(/\s+/).map(parseFloat);return[u,c]});s.push(l)}}else{const a=/\(\s*([\d.\s,-]+)\s*\)/g;let l;for(;(l=a.exec(e))!==null;){const h=l[1].split(",").map(c=>{const[u,m]=c.trim().split(/\s+/).map(parseFloat);return[m,u]});h.length>0&&s.push(h)}}return s.length===0?null:{type:n==="MULTILINESTRING"?"MultiLineString":"LineString",coordinates:s}}#q(e){if(e.type==="address"&&e.subtype){const n=e.subtype.toLowerCase();if(n==="provincie")return 5e4;if(n==="gemeente")return 2e4;if(n==="woonplaats")return 15e3;if(n==="wijk"||n==="buurt")return 3e3;if(n==="weg")return 5e3}return this.radius}#N(e=!1){const n=this.#t.querySelector(".search__listbox"),s=this.#t.querySelector(".search__input");if(this.#s.length===0){n.innerHTML=`
			...
			`,this.#r=-1;return}let a="";e&&(a='<li class="search__no-results" part="no-results" role="option" aria-disabled="true">Zoeken in adressen niet beschikbaar</li>');const l=this.#s.filter(v=>v.type==="feature"||v.type==="marker"),h=this.#s.filter(v=>v.type==="address"),c=l.length>0&&h.length>0,u=(v,_)=>{const g=_===this.#r;return`
				...
				>
					...
					<span class="search__result-label">${this.#j(v.label)}</span>
				</li>
			`};let m="";c?(m+='<li class="search__group-label" part="group-label" role="presentation">Op de kaart</li>',m+=l.map(v=>u(v,this.#s.indexOf(v))).join(""),m+='<li class="search__group-label" part="group-label" role="presentation">Adressen</li>',m+=h.map(v=>u(v,this.#s.indexOf(v))).join("")):m+=this.#s.map((v,_)=>u(v,_)).join(""),n.innerHTML=m+a,this.#r>=0?s.setAttribute("aria-activedescendant",`search-option-${this.#r}`):s.removeAttribute("aria-activedescendant")}#V(e){switch(e.type){case"address":return e.subtype||"Adres";case"feature":return e.subtype||"Object";case"marker":return"Marker";default:return""}}#X(e){switch(e.type){case"address":return'<svg aria-hidden="true" width="20" height="20"><use href="#icon-map-pin"/></svg>';case"feature":return'<svg aria-hidden="true" width="20" height="20"><use href="#icon-hamburger"/></svg>';case"marker":return'<svg aria-hidden="true" width="20" height="20"><use href="#icon-map-pin"/></svg>';default:return""}}#J(){const e=this.#t.querySelector(".search__listbox"),n=this.#t.querySelector(".search__input"),s=this.#t.querySelector(".search__form");e.hidden=!1,n.setAttribute("aria-expanded","true"),s.dataset.open="true"}#Z(){const e=this.#t.querySelector(".search__listbox"),n=this.#t.querySelector(".search__input"),s=this.#t.querySelector(".search__form");e.hidden=!0,n.setAttribute("aria-expanded","false"),n.removeAttribute("aria-activedescendant"),this.#r=-1,delete s.dataset.open}#G(e){const n=this.#s.length-1;if(n<0)return;this.#r+=e,this.#r<0?this.#r=n:this.#r>n&&(this.#r=0),this.#N();const s=this.#t.querySelector(`#search-option-${this.#r}`);s&&s.scrollIntoView({block:"nearest"})}#D(e){const n=this.#s[e];if(!n)return;const s=this.#t.querySelector(".search__input"),a=this.#t.querySelector(".search__clear");s.value=n.label,a&&(a.hidden=!n.label),this.#Z(),this.#K(n),this.#n.hasAttribute("list-open")||this.#Y(n),this.dispatchEvent(new CustomEvent("dm-search:select",{bubbles:!0,composed:!0,detail:{type:n.type,label:n.label,coordinates:n.coordinates,bounds:n.bounds,feature:n.feature,marker:n.marker,raw:n.raw}}))}#K(e){const n=this.#n.map;if(!n)return;this.#U();const s=e.geometry?.type||"";s.includes("Polygon")||s.includes("Line")?this.#Q(e):e.type==="address"&&e.coordinates&&this.#R(e.coordinates);let a;if(this.#l?.getBounds)a=this.#l.getBounds();else if(e.bounds)a=e.bounds;else if(e.coordinates){const l=G.latLng(e.coordinates[0],e.coordinates[1]),h=this.#q(e);a=l.toBounds(h)}a&&(n.fitBounds(a,{padding:[40,40]}),this.dispatchEvent(new CustomEvent("dm-search:zoom",{bubbles:!0,composed:!0,detail:{bounds:a,result:e}})))}#Q(e){const n=this.#n.map;if(!n||!e.geometry)return;const s=e.geometry,a=s.type==="LineString"||s.type==="MultiLineString",l=this.#H(),h={color:l,weight:a?4:2,opacity:.8,fillColor:l,fillOpacity:a?0:.15};s.type==="Polygon"||s.type==="MultiPolygon"?this.#l=G.polygon(s.coordinates,h):s.type==="LineString"?this.#l=G.polyline(s.coordinates[0],h):s.type==="MultiLineString"&&(this.#l=G.polyline(s.coordinates,h)),this.#l&&this.#l.addTo(n)}#R(e){const n=this.#n?.map;!n||!e||(this.#l=G.circleMarker(e,{radius:9,color:"#fff",weight:2,fillColor:this.#H(),fillOpacity:1,opacity:1}).addTo(n))}#H(){const e=getComputedStyle(this);return e.getPropertyValue("--draad-map-components-search-highlight-color").trim()||e.getPropertyValue("--draad-map-components-color-primary").trim()||"#268641"}#Y(e){if(e.type==="marker"&&e.marker)e.marker.active=!0,e.marker.marker?.setZIndexOffset?.(1e3),this.#h=e.marker,e.marker.dispatchEvent(new CustomEvent("dm-marker:click",{bubbles:!0,composed:!0,detail:{marker:e.marker.marker??null,targetId:e.marker.target}}));else if(e.type==="feature"&&e.source){const n=e.source.tagName==="DM-WFS"?"wfs":"geojson";e.source.dispatchEvent(new CustomEvent(`dm-${n}:feature-click`,{bubbles:!0,composed:!0,detail:{feature:e.feature,layer:e.layer,latlng:null}}))}}#U(){this.#l&&this.#n?.map&&(this.#n.map.removeLayer(this.#l),this.#l=null),this.#n?.querySelectorAll("dm-geojson, dm-wfs").forEach(e=>e.clearActiveFeature?.()),this.#h&&(this.#h.active=!1,this.#h.marker?.setZIndexOffset?.(0),this.#h=null)}#B(e){const n=this.#t.querySelector(".search__button");e?(n.classList.add("search__button--loading"),n.setAttribute("aria-busy","true")):(n.classList.remove("search__button--loading"),n.removeAttribute("aria-busy"))}#$(e){const n=this.#t.querySelector('[role="status"]');n&&(n.textContent="",setTimeout(()=>{n.textContent=e},100))}#j(e){const n=document.createElement("div");return n.textContent=e,n.innerHTML}#F(e){return String(e).replace(/&/g,"&amp;").replace(/"/g,"&quot;").replace(/'/g,"&#39;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}disconnectedCallback(){this.#i&&(this.#i.abort(),this.#i=null),this.#a&&(clearTimeout(this.#a),this.#a=null),this.#o&&(clearTimeout(this.#o),this.#o=null),this.#U(),this.#n=null,this.#s=[]}}customElements.define("dm-search",tu);const eu=`/* dm-infowindow - Card panel styling */
:host {
	display: flex;
	flex-direction: column;
	max-block-size: 100%;
...
`;class iu extends HTMLElement{#t;#n=null;#e=null;#i=null;#a=null;#o=null;#r=null;#s=null;#l=null;#h=null;#d=!1;#f;constructor(){super(),this.#t=this.attachShadow({mode:"open"}),this.#f=this.#c()}#c(){const e=new CSSStyleSheet;e.replaceSync(eu),this.#t.adoptedStyleSheets=[e]}static get observedAttributes(){return["for","feature-id","trigger"]}get for(){return this.getAttribute("for")}set for(e){this.setAttribute("for",e)}get featureId(){return this.getAttribute("feature-id")}set featureId(e){this.setAttribute("feature-id",e)}get trigger(){return this.getAttribute("trigger")||"click"}set trigger(e){this.setAttribute("trigger",e)}get isOpen(){return this.#d}connectedCallback(){const e=this.closest("dm-map");e&&(this.#n=e,this.setAttribute("slot","top-right"),this.#g(),this.setAttribute("hidden",""),Ut(this.#t),e.map?this.#u():e.addEventListener("dm-map:ready",()=>{this.#u()},{once:!0}))}async#u(){await this.#f,this.#v(),this.#o=e=>this.#p(e),this.#n.addEventListener("dm-infowindow:open",this.#o)}#p(e){e.target!==this&&this.isOpen&&this.close()}#g(){this.#t.innerHTML=`
		...
		`,this.#t.querySelector(".infowindow__close").addEventListener("click",()=>this.close())}#v(){const e=this.for;e&&(this.#e=document.getElementById(e),this.#e?this.#m():this.#k(e))}#k(e){this.#s&&this.#s.disconnect(),this.#s=new MutationObserver((n,s)=>{const a=document.getElementById(e);a&&(this.#e=a,this.#m(),s.disconnect(),this.#s=null)}),this.#s.observe(this.#n,{childList:!0,subtree:!0})}#m(){const e=this.trigger,n=this.#e.tagName.toLowerCase();n==="dm-marker"?this.#P(e):(n==="dm-geojson"||n==="dm-wfs")&&this.#E(e,n)}#w(){if(this.#e&&(this.#i&&(this.#e.removeEventListener("dm-marker:click",this.#i),this.#i=null),this.#a)){const e=this.#e.tagName.toLowerCase().replace("dm-","");this.#e.removeEventListener(`dm-${e}:feature-click`,this.#a),this.#a=null}}#P(e){e==="click"&&(this.#i=n=>this.#x(n),this.#e.addEventListener("dm-marker:click",this.#i))}#E(e,n){const a=`dm-${n.replace("dm-","")}:feature-click`;e==="click"&&(this.#a=l=>this.#A(l),this.#e.addEventListener(a,this.#a))}#x(e){if(this.#h=null,this.isOpen)this.close();else{const n=this.#C();this.#q(n),this.open()}}#A(e){const{feature:n}=e.detail;if(!this.#L(n))return;this.#h=n;const s=this.#_(n);this.#q(s),this.#I(this,n),this.open()}#L(e){const n=this.featureId;return!n||n==="*"||e.id!==void 0&&String(e.id)===n||e.properties?.id!==void 0&&String(e.properties.id)===n}#C(){const e=document.createElement("div"),n=this.querySelector("template");if(n)e.appendChild(n.content.cloneNode(!0));else for(const s of this.childNodes)s.nodeType===Node.ELEMENT_NODE&&s.hasAttribute("slot")||e.appendChild(s.cloneNode(!0));return this.#b(e),e}#_(e){const n=document.createElement("div"),s=this.querySelector("template");if(s){const a=s.content.cloneNode(!0);n.appendChild(a),this.#I(n,e),this.#T(n)}else if(this.#e&&this.#M()){const a=this.#y(e);a&&n.appendChild(a)}else for(const a of this.childNodes)a.nodeType===Node.ELEMENT_NODE&&a.hasAttribute("slot")||n.appendChild(a.cloneNode(!0));return this.#b(n),n}#M(){return this.#e?.getAttribute("infowindow-properties")}#b(e){const n=a=>{const l=document.createElementNS("http://www.w3.org/2000/svg","svg");l.setAttribute("aria-hidden","true");const h=document.createElementNS("http://www.w3.org/2000/svg","use");return h.setAttribute("href",`#${a}`),l.appendChild(h),l},s=a=>{const l=a.getAttribute("href");if(!l)return!1;try{return new URL(l,window.location.href).origin!==window.location.origin}catch{return!1}};e.querySelectorAll(".address, address").forEach(a=>{a.setAttribute("part","address"),a.prepend(n("icon-map-pin"))}),e.querySelectorAll(".action, a.button, button.action").forEach(a=>{a.setAttribute("part","action"),s(a)&&a.prepend(n("icon-external-link"))})}#y(e){const n=this.#e.getAttribute("infowindow-properties"),s=this.#e.getAttribute("infowindow-labels");if(!n)return null;const a=n.split(",").map(c=>c.trim()),l=s?s.split(",").map(c=>c.trim()):a,h=document.createElement("dl");h.className="dm-infowindow-data",h.setAttribute("part","data-table");for(let c=0;c<a.length;c++){const u=e.properties?.[a[c]];if(u==null||u==="")continue;const m=document.createElement("dt");m.textContent=l[c]||a[c],h.appendChild(m);const v=document.createElement("dd");v.innerHTML=u!==null&&typeof u=="object"?JSON.stringify(u):String(u),h.appendChild(v)}return h.children.length>0?h:null}#I(e,n){const s=new Set(["https:","http:","mailto:","tel:"]),a=(l,h)=>{l.style.display=h?"":"none"};e.querySelectorAll("[data-field]").forEach(l=>{const h=this.#z(n,l.getAttribute("data-field")),c=h!=null?String(h):"";l.textContent=c,a(l,c!=="")}),e.querySelectorAll("[data-href]").forEach(l=>{const h=this.#z(n,l.getAttribute("data-href"));let c=!1;if(h!=null)try{const u=new URL(String(h),window.location.origin);s.has(u.protocol)?(l.setAttribute("href",String(h)),c=!0):l.removeAttribute("href")}catch{l.removeAttribute("href")}else l.removeAttribute("href");a(l,c)}),e.querySelectorAll("[data-src]").forEach(l=>{const h=this.#z(n,l.getAttribute("data-src"));let c=!1;if(h!=null)try{const u=new URL(String(h),window.location.origin);u.protocol==="https:"||u.protocol==="http:"?(l.setAttribute("src",String(h)),c=!0):l.removeAttribute("src")}catch{l.removeAttribute("src")}else l.removeAttribute("src");a(l,c)})}#T(e){e.querySelectorAll("dl.dm-infowindow-data").forEach(n=>{const s=Array.from(n.children);let a=!1;s.forEach((l,h)=>{if(l.tagName!=="DD")return;if(l.style.display==="none"||l.textContent===""){l.style.display="none";const u=s[h-1];u&&u.tagName==="DT"&&(u.style.display="none")}else a=!0}),a||(n.style.display="none")})}#z(e,n){if(!n.startsWith("properties.")&&n!=="id"&&n!=="properties")return;const s=new Set(["__proto__","constructor","prototype"]),a=n.split(".");let l=e;for(const h of a){if(l==null||s.has(h)||!Object.prototype.hasOwnProperty.call(l,h))return;l=l[h]}return l}#q(e){const n=this.#t.querySelector(".infowindow__content");for(n.innerHTML="";e.firstChild;)n.appendChild(e.firstChild);n.querySelectorAll("a").forEach(s=>s.setAttribute("part","link"))}open(){this.#t.querySelector(".infowindow").removeAttribute("hidden"),this.removeAttribute("hidden"),this.#d=!0,this.#N(),this.dispatchEvent(new CustomEvent("dm-infowindow:open",{bubbles:!0,composed:!0,detail:{target:this.#e,feature:this.#h}}))}close(){this.#t.querySelector(".infowindow").setAttribute("hidden",""),this.setAttribute("hidden",""),this.#d=!1,this.#r&&(document.removeEventListener("keydown",this.#r),this.#r=null),this.#e?.tagName.toLowerCase()==="dm-marker"?this.#e.active=!1:this.#e?.clearActiveFeature?.(),this.#l&&typeof this.#l.focus=="function"&&this.#l.focus(),this.#l=null,this.dispatchEvent(new CustomEvent("dm-infowindow:close",{bubbles:!0,composed:!0,detail:{target:this.#e}}))}toggle(){this.isOpen?this.close():this.open()}#N(){const e=this.#t.querySelector(".infowindow");this.#l=document.activeElement,e.setAttribute("tabindex","-1"),e.focus(),this.#r=n=>{n.key==="Escape"&&this.isOpen&&this.close()},document.addEventListener("keydown",this.#r)}attributeChangedCallback(e,n,s){if(!(n===s||!this.#n))switch(e){case"for":this.#w(),this.#e=null,this.#v();break;case"trigger":this.#w(),this.#e&&this.#m();break}}disconnectedCallback(){this.#w(),this.#o&&(this.#n?.removeEventListener("dm-infowindow:open",this.#o),this.#o=null),this.#r&&(document.removeEventListener("keydown",this.#r),this.#r=null),this.#s&&(this.#s.disconnect(),this.#s=null),this.#n=null,this.#e=null,this.#l=null,this.#h=null}}customElements.define("dm-infowindow",iu);const nu=`.icon {
	display: block;
	inline-size: 1em;
	block-size: 1em;
	fill: currentColor;
...
`,au=new Set(["http:","https:","mailto:","tel:"]),ou=new Set(["__proto__","constructor","prototype"]);class lu extends HTMLElement{#t;#n=[];#e=new Map;#i=null;#a=null;#o=!1;#r;#s=null;#l=null;#h=new Map;#d=new Map;#f=null;#c=1;#u=null;#p=new Map;constructor(){super(),this.#t=this.attachShadow({mode:"open"}),this.#r=this.#g()}#g(){const e=new CSSStyleSheet;e.replaceSync(ms),this.#t.adoptedStyleSheets=[e],this.#l=new CSSStyleSheet,this.#l.replaceSync(su)}static get observedAttributes(){return["for","label","columns","per-page","prev-label","next-label","page-label","open"]}attributeChangedCallback(e){if(e==="open"){const n=this.hasAttribute("open");if(!this.#s||n===this.#o)return;n?this.#x():this.#A();return}this.#o&&(e==="per-page"&&(this.#c=1),this.#_())}get for(){return this.getAttribute("for")}get label(){return this.getAttribute("label")||"Lijst bekijken"}get shortLabel(){return this.getAttribute("short-label")||"Lijst"}get columns(){const e=parseInt(this.getAttribute("columns"),10);return e>=1&&e<=4?e:3}get perPage(){const e=parseInt(this.getAttribute("per-page"),10);return e>=1&&e<=200?e:12}get prevLabel(){return this.getAttribute("prev-label")||"Vorige"}get nextLabel(){return this.getAttribute("next-label")||"Volgende"}get pageLabelTemplate(){return this.getAttribute("page-label")||"Pagina {current} van {total}"}connectedCallback(){const e=this.closest("dm-map");e&&(e.map?this.#v(e):(this.#f=()=>this.#v(e),e.addEventListener("dm-map:ready",this.#f,{once:!0})))}async#v(e){this.#s=e,await this.#r,this.#k(),Ut(this.#t),this.#m(),this.#w(),this.#P(),this.hasAttribute("open")&&this.#x()}#k(){const e=document.createElement("div");e.className="list",e.setAttribute("part","toggle-wrapper");const n=document.createElement("button");n.className="list__toggle",n.type="button",n.setAttribute("part","toggle"),n.setAttribute("aria-pressed","false"),n.setAttribute("aria-label",this.label),n.innerHTML='<svg class="list__icon" part="toggle-icon" aria-hidden="true"><use href="#icon-list"/></svg>';const s=document.createElement("span");s.className="list__text list__text--full",s.setAttribute("part","toggle-text-full"),s.textContent=this.label,n.appendChild(s);const a=document.createElement("span");a.className="list__text list__text--short",a.setAttribute("part","toggle-text-short"),a.textContent=this.shortLabel,n.appendChild(a),n.addEventListener("click",()=>{this.#E(),this.#o?this.#N():n.focus()}),e.appendChild(n),this.#t.appendChild(e)}#m(){const e=this.for;if(!e)return;const n=e.split(",").map(s=>s.trim()).filter(Boolean);this.#n=[],n.forEach(s=>{const a=this.#s.querySelector(`#${CSS.escape(s)}`);a&&this.#n.push(a)})}#w(){this.#n.forEach(e=>{const n=h=>{this.#e.set(e.id,h.detail.filters),this.#c=1,this.#o&&this.#_()};this.#h.set(e,n),e.addEventListener("dm-filter:apply",n);const s=e.tagName.toLowerCase(),a=s==="dm-geojson"?"dm-geojson:ready":s==="dm-wfs"?"dm-wfs:ready":"dm-layer:ready",l=()=>{this.#c=1,this.#o&&this.#_()};this.#d.set(e,{event:a,handler:l}),e.addEventListener(a,l)})}#P(){Object.entries({"dm-search:select":n=>{const s=n.detail?.coordinates;this.#u=Array.isArray(s)&&s.length>=2?[s[0],s[1]]:null,this.#c=1,this.#o&&this.#_()},"dm-search:clear":()=>{this.#u=null,this.#c=1,this.#o&&this.#_()}}).forEach(([n,s])=>{this.#p.set(n,s),this.#s.addEventListener(n,s)})}#E(){this.toggleAttribute("open",!this.#o)}#x(){this.#o=!0,this.toggleAttribute("open",!0);const e=this.#t.querySelector(".list__toggle");e.setAttribute("aria-pressed","true");const n=e.querySelector(".list__icon");e.querySelector(".list__text--full").textContent="Kaart bekijken",e.querySelector(".list__text--short").textContent="Kaart",n.innerHTML='<use href="#icon-map"/>',this.#i||(this.#i=document.createElement("div"),this.#i.setAttribute("slot","list"),this.#a=this.#i.attachShadow({mode:"open"}),this.#l&&(this.#a.adoptedStyleSheets=[this.#l]),this.#s.appendChild(this.#i)),this.#c=1,this.#_(),this.dispatchEvent(new CustomEvent("dm-list:open",{bubbles:!0,composed:!0,detail:{source:this}}))}#A(){this.#o=!1,this.toggleAttribute("open",!1);const e=this.#t.querySelector(".list__toggle");e.setAttribute("aria-pressed","false");const n=e.querySelector(".list__icon");e.querySelector(".list__text--full").textContent=this.label,e.querySelector(".list__text--short").textContent=this.shortLabel,n.innerHTML='<use href="#icon-list"/>',this.dispatchEvent(new CustomEvent("dm-list:close",{bubbles:!0,composed:!0,detail:{source:this}}))}#L(){const e=[];return this.#n.forEach(n=>{const s=n.data;if(!s?.features)return;let a=s.features;const l=this.#e.get(n.id);l&&Object.keys(l).length>0&&(a=Pe(a,l)),a.forEach(h=>{e.push({feature:h,source:n})})}),this.#u?e.map(n=>({...n,distance:this.#C(n.feature,n.source)})).sort((n,s)=>(n.distance??1/0)-(s.distance??1/0)):e}#C(e,n){const s=e.geometry&&this.#T(e.geometry);if(!s)return null;let[a,l]=s;if(Ri(e)){const g=he(n?.getAttribute("crs"))||"EPSG:28992";[a,l]=ii([s[0],s[1]],g)}if(!Number.isFinite(l)||!Number.isFinite(a))return null;const h=Math.PI/180,[c,u]=this.#u,m=(l-c)*h,v=(a-u)*h,_=Math.sin(m/2)**2+Math.cos(c*h)*Math.cos(l*h)*Math.sin(v/2)**2;return 12742*Math.asin(Math.min(1,Math.sqrt(_)))}#_(){if(!this.#a)return;const e=this.querySelector("template"),n=this.#L(),s=n.length,a=this.perPage,l=Math.max(1,Math.ceil(s/a));this.#c>l&&(this.#c=l),this.#c<1&&(this.#c=1);const h=(this.#c-1)*a,c=Math.min(h+a,s),u=n.slice(h,c);if(n.length===0){this.#a.innerHTML=`
				<div class="list__panel" part="panel">
					<p class="list__empty" part="empty">Geen resultaten gevonden.</p>
				</div>
			`,Ut(this.#a);return}const m=document.createElement("div");m.className="list__panel",m.setAttribute("part","panel"),m.style.setProperty("--draad-map-components-list-columns",this.columns);const v=document.createElement("p");v.className="list__count",v.setAttribute("part","count"),v.setAttribute("role","status"),v.setAttribute("aria-live","polite"),v.textContent=s<=a?`${s} ${s!==1?"resultaten":"resultaat"}`:`${h+1}–${c} van ${s} resultaten`,m.appendChild(v);const _=document.createElement("div");_.className="list__grid",_.setAttribute("part","grid");const g=e?.content.querySelector("a[href], [data-href]")??null;if(u.forEach(({feature:w,source:x},S)=>{const P=h+S,C=document.createElement("article");if(C.className="list__card",C.setAttribute("part","card"),C.setAttribute("tabindex","0"),g||C.setAttribute("role","button"),e){const E=e.content.cloneNode(!0);this.#b(E,w),C.appendChild(E)}else{const E=w.properties?.name||w.properties?.naam||w.id||`Feature ${P+1}`,z=document.createElement("h3");z.textContent=String(E),C.appendChild(z)}this.#M(C),C.addEventListener("click",E=>{E.target.closest("a[href]")||(this.dispatchEvent(new CustomEvent("dm-list:item-click",{bubbles:!0,composed:!0,detail:{feature:w,index:P,source:x}})),this.#A(),this.#I(w,x))}),C.addEventListener("keydown",E=>{E.key==="Enter"&&!E.target.closest("a[href]")&&C.click()}),_.appendChild(C)}),m.appendChild(_),l>1){const w=document.createElement("nav");w.className="list__pagination",w.setAttribute("part","pagination"),w.setAttribute("aria-label","Paginering");const x=document.createElement("button");x.type="button",x.className="list__pagination-arrow",x.setAttribute("part","pagination-prev"),x.setAttribute("aria-label",this.prevLabel),x.dataset.dir="prev",this.#c===1&&(x.disabled=!0),x.innerHTML='<svg class="list__pagination-icon" aria-hidden="true" focusable="false"><use href="#icon-chevron-left"/></svg>';const S=document.createElement("div");S.className="list__pagination-pages",S.setAttribute("role","status"),S.setAttribute("aria-live","polite"),S.setAttribute("aria-label",this.pageLabelTemplate.replace("{current}",this.#c).replace("{total}",l)),this.#z(this.#c,l).forEach(C=>{if(C==="..."){const E=document.createElement("span");E.className="list__pagination-ellipsis",E.setAttribute("aria-hidden","true"),E.textContent="…",S.appendChild(E)}else{const E=document.createElement("button");E.type="button",E.className="list__pagination-page",E.dataset.page=C,E.textContent=C,C===this.#c&&(E.classList.add("list__pagination-page--active"),E.setAttribute("aria-current","page")),S.appendChild(E)}});const P=document.createElement("button");P.type="button",P.className="list__pagination-arrow",P.setAttribute("part","pagination-next"),P.setAttribute("aria-label",this.nextLabel),P.dataset.dir="next",this.#c===l&&(P.disabled=!0),P.innerHTML='<svg class="list__pagination-icon" aria-hidden="true" focusable="false"><use href="#icon-chevron-right"/></svg>',w.append(x,S,P),w.addEventListener("click",C=>{const E=C.target.closest("button[data-page]");if(E&&!E.disabled){this.#q(parseInt(E.dataset.page,10));return}const z=C.target.closest("button[data-dir]");!z||z.disabled||this.#q(z.dataset.dir==="next"?this.#c+1:this.#c-1)}),m.appendChild(w)}this.#a.innerHTML="",Ut(this.#a),this.#a.appendChild(m)}#M(e){const n=a=>{const l=document.createElementNS("http://www.w3.org/2000/svg","svg");l.setAttribute("aria-hidden","true");const h=document.createElementNS("http://www.w3.org/2000/svg","use");return h.setAttribute("href",`#${a}`),l.appendChild(h),l},s=a=>{const l=a.getAttribute("href");if(!l)return!1;try{return new URL(l,window.location.href).origin!==window.location.origin}catch{return!1}};e.querySelectorAll(".address, address").forEach(a=>a.prepend(n("icon-map-pin"))),e.querySelectorAll(".action, a.button").forEach(a=>{s(a)&&a.prepend(n("icon-external-link"))})}#b(e,n){const s=(a,l)=>{a.style.display=l?"":"none"};e.querySelectorAll("[data-field]").forEach(a=>{const l=this.#y(n,a.getAttribute("data-field")),h=l!=null?String(l):"";a.textContent=h,s(a,h!=="")}),e.querySelectorAll("[data-href]").forEach(a=>{const l=a.getAttribute("data-href"),h=this.#y(n,l);if(h!=null){const c=String(h);try{const u=new URL(c,window.location.origin);au.has(u.protocol)?a.setAttribute("href",c):a.removeAttribute("href")}catch{a.removeAttribute("href")}}else a.removeAttribute("href")}),e.querySelectorAll("[data-src]").forEach(a=>{const l=a.getAttribute("data-src"),h=this.#y(n,l);let c=!1;if(h!=null){const u=String(h);try{const m=new URL(u,window.location.origin);m.protocol==="https:"||m.protocol==="http:"?(a.setAttribute("src",u),c=!0):a.removeAttribute("src")}catch{a.removeAttribute("src")}}else a.removeAttribute("src");s(a,c)}),e.querySelectorAll("[data-chips]").forEach(a=>{const l=a.getAttribute("data-chips"),h=this.#y(n,l);if(h!=null){const c=String(h).split(",").map(u=>u.trim()).filter(Boolean);a.innerHTML="",c.forEach(u=>{const m=document.createElement("span");m.className="chip",m.textContent=u,a.appendChild(m)})}}),e.querySelectorAll("dl.dm-infowindow-data").forEach(a=>{let l=!1;a.querySelectorAll("dd").forEach(h=>{const c=h.style.display==="none"||h.textContent.trim()==="",u=h.previousElementSibling;u&&u.tagName==="DT"&&s(u,!c),c||(l=!0)}),l||s(a,!1)}),e.querySelectorAll(".chips").forEach(a=>{[...a.children].some(h=>h.style.display!=="none"&&h.textContent.trim()!=="")||s(a,!1)})}#y(e,n){if(!n.startsWith("properties.")&&n!=="id"&&n!=="properties")return;const s=n.split(".");let a=e;for(const l of s){if(a==null||ou.has(l)||!Object.prototype.hasOwnProperty.call(a,l))return;a=a[l]}return a}async#I(e,n){if(!this.#s?.map)return;const s=e.geometry;if(!s)return;const a=this.#s.map,h=Ri(e)?he(n?.getAttribute("crs"))||"EPSG:28992":null,c=(u,m)=>{if(h){const[v,_]=ii([u,m],h);return[_,v]}return[m,u]};if(s.type==="Point"){const[u,m]=s.coordinates;a.setView(c(u,m),Math.max(a.getZoom(),16))}else try{const u=(await Promise.resolve().then(()=>Ia)).default,m=h?{coordsToLatLng:_=>u.latLng(c(_[0],_[1]))}:{},v=u.geoJSON(e,m);a.fitBounds(v.getBounds(),{padding:[50,50]})}catch{const u=this.#T(s);u&&a.setView(c(u[0],u[1]),Math.max(a.getZoom(),16))}}#T(e){let n=e.coordinates;for(;Array.isArray(n)&&Array.isArray(n[0]);)n=n[0];return Array.isArray(n)&&n.length>=2?n:null}#z(e,n){return n<=5?Array.from({length:n},(s,a)=>a+1):e<=3?[1,2,3,"...",n]:e>=n-2?[1,"...",n-3,n-2,n-1,n]:[1,"...",e-1,e,e+1,"...",n]}#q(e){const n=this.perPage,s=this.#L().length,a=Math.max(1,Math.ceil(s/n));this.#c=Math.max(1,Math.min(e,a)),this.#_(),this.#i?.scrollIntoView({block:"start",behavior:"smooth"}),this.#N()}#N(){requestAnimationFrame(()=>{this.#a?.querySelector(".list__card")?.focus()})}disconnectedCallback(){this.#f&&(this.closest("dm-map")?.removeEventListener("dm-map:ready",this.#f),this.#f=null),this.#h.forEach((e,n)=>{n.removeEventListener("dm-filter:apply",e)}),this.#h.clear(),this.#d.forEach(({event:e,handler:n},s)=>{s.removeEventListener(e,n)}),this.#d.clear(),this.#p.forEach((e,n)=>{this.#s?.removeEventListener(n,e)}),this.#p.clear(),this.#u=null,this.#i?.parentNode&&this.#i.parentNode.removeChild(this.#i),this.#i=null,this.#a=null,this.#n=[],this.#e.clear(),this.#s=null}}customElements.define("dm-list",lu);const hu=`.icon {
	display: block;
	inline-size: 1em;
	block-size: 1em;
	fill: currentColor;
...
`;class cu extends HTMLElement{#t;#n=null;#e=[];#i={};#a={};#o=new Map;#r=new WeakMap;#s=new Map;#l=new Map;#h;#d=!1;#f=!1;#c=null;#u=null;#p=null;#g=!1;#v=null;constructor(){super(),this.#t=this.attachShadow({mode:"open"}),this.#h=this.#k()}#k(){const e=new CSSStyleSheet;e.replaceSync(hu),this.#t.adoptedStyleSheets=[e]}get#m(){const e=this.getAttribute("variant");return e==="dropdown"||e==="sidebar"?e:"dialog"}get#w(){return this.getAttribute("submit")==="auto"}get#P(){return this.getAttribute("dismiss")==="close"?"close":"actions"}get#E(){return this.hasAttribute("collapsible")}get#x(){return this.getAttribute("bool-label")||"Ja"}connectedCallback(){const e=this.closest("dm-map");e&&(e.map?this.#A(e):e.addEventListener("dm-map:ready",()=>{this.#A(e)},{once:!0}))}async#A(e){if(this.#n=e,await this.#h,this.#L(),this.#C(),this.#q(),Ut(this.#t),this.#Y(),this.#G(),this.#B(),this.hasAttribute("open")&&this.#m==="sidebar"){const s=this.#t.querySelector(".filter__panel--sidebar"),a=this.#t.querySelector(".filter__toggle");s?.classList.add("filter__panel--open"),a?.setAttribute("aria-expanded","true"),this.#f=!0}this.#it()&&(this.#d=!0,this.#a=JSON.parse(JSON.stringify(this.#i))),this.#v=()=>this.#it(!0),window.addEventListener("popstate",this.#v)}#L(){const e=["dm-geojson[filter-property], dm-geojson[filter-properties]","dm-wfs[filter-property], dm-wfs[filter-properties]","dm-layer[filter-property], dm-layer[filter-properties]"];this.#e=[],e.forEach(n=>{this.#n.querySelectorAll(n).forEach(s=>{const a=s.getAttribute("filter-properties"),l=s.getAttribute("filter-labels"),h=s.getAttribute("filter-property"),c=s.getAttribute("filter-label"),u=s.getAttribute("filter-types"),m=s.getAttribute("filter-collapsed"),v=s.getAttribute("filter-bool-labels");let _=[],g=[],w=[],x=[],S=[];if(a){for(_=a.split(",").map(E=>E.trim()).filter(Boolean),l&&(g=l.split(",").map(E=>E.trim()).filter(Boolean)),v&&(S=v.split(",").map(E=>E.trim())),u&&(w=u.split(",").map(E=>E.trim()).filter(Boolean)),m&&(x=m.split(",").map(E=>E.trim()).filter(Boolean));g.length<_.length;)g.push(_[g.length]);for(;w.length<_.length;)w.push("auto");for(;x.length<_.length;)x.push("false");for(;S.length<_.length;)S.push("")}else h&&(_=[h],g=[c||h],w=[u||"auto"],x=[m||"false"],S=[v||""]);if(_.length===0)return;const P=s.id||`filter-source-${this.#e.length}`,C=s.getAttribute("filter-key");if(_.forEach((E,z)=>{this.#e.push({element:s,label:g[z],property:E,groupKey:C||E,type:s.tagName.toLowerCase(),id:P,filterType:w[z]||"auto",collapsed:x[z]==="true",boolLabel:S[z]||""})}),!this.#r.has(s))if(this.#r.set(s,!0),s.data)_.forEach(E=>{this.#M(s,E)});else{const E=s.tagName==="DM-GEOJSON"?"dm-geojson:ready":s.tagName==="DM-WFS"?"dm-wfs:ready":"dm-layer:ready";let z=!1;s.addEventListener(E,()=>{z||(z=!0,_.forEach(R=>{this.#M(s,R)}),this.#C(),this.#G(),this.#B())},{once:!0}),s.data&&!z&&(z=!0,_.forEach(R=>{this.#M(s,R)}))}})})}#C(){this.#l=new Map,this.#e.forEach(e=>{this.#l.has(e.groupKey)||this.#l.set(e.groupKey,{label:e.label,filterType:e.filterType,collapsed:e.collapsed,boolLabel:e.boolLabel,sources:[]});const n=this.#l.get(e.groupKey);n.sources.find(a=>a.element===e.element&&a.property===e.property)||n.sources.push({element:e.element,id:e.id,property:e.property})})}#_(e,n){const s=new Set;if(n.sources.forEach(({id:l,property:h})=>{const c=`${l}:${h}`,u=this.#o.get(c);u&&u.values.forEach(m=>s.add(m))}),s.size===0)return null;const a=Array.from(s).sort((l,h)=>typeof l=="number"&&typeof h=="number"?l-h:String(l).localeCompare(String(h)));return{values:a,valueType:this.#I(a)}}#M(e,n){const s=this.#b(e,n),a=this.#I(s),l=this.#e.find(c=>c.element===e&&c.property===n);if(!l)return;const h=`${l.id}:${n}`;this.#o.set(h,{values:s,valueType:a}),this.#d&&Object.keys(this.#i).length>0&&this.#F(),this.#K()&&(this.#G(),this.#B())}#b(e,n){if(!e.data?.features)return[];const s=new Set;return e.data.features.forEach(a=>{const l=a.properties?.[n];if(l!=null){const h=String(l);h.includes(",")?h.split(",").forEach(c=>{const u=c.trim();u&&s.add(u)}):s.add(l)}}),Array.from(s).sort((a,l)=>typeof a=="number"&&typeof l=="number"?a-l:String(a).localeCompare(String(l)))}#y(e,n){const s=new Map;return n.sources.forEach(({element:a,property:l})=>{a.data?.features&&a.data.features.forEach(h=>{const c=h.properties?.[l];if(c==null)return;const u=String(c);(u.includes(",")?u.split(",").map(v=>v.trim()).filter(Boolean):[u]).forEach(v=>{s.set(v,(s.get(v)||0)+1)})})}),s}#I(e){if(e.length===0)return{isNumeric:!1};if(e.length===1)return{isNumeric:!1,single:!0};if(e.every(s=>typeof s=="number"?!0:typeof s=="string"?!isNaN(Number(s))&&s.trim()!=="":!1)){const s=e.map(a=>Number(a));return{isNumeric:!0,min:Math.min(...s),max:Math.max(...s)}}return{isNumeric:!1}}#T(e,n){const s=this.#l.get(e)?.filterType;return s&&s!=="auto"?s==="range"&&!n.valueType.isNumeric?this.#z(n):s:this.#z(n)}#z({values:e,valueType:n}){return n.isNumeric&&!n.single?"range":e.length<=20?"checkbox":"dropdown"}#q(){const e=this.#m;e==="dropdown"?this.#J():e==="sidebar"?this.#Z():this.#X()}#N(){return`
			<button
				part="toggle"
		...
		`}#V(){const e=this.#w?" filter--auto-submit":"",n=this.getAttribute("label")||"Filters";return`
		...
		`}#X(){const e=this.getAttribute("label")||"Filters",n=this.#w?" filter--auto-submit":"";this.#t.innerHTML=`
		...
		`}#J(){const e=this.getAttribute("label")||"Filters",n=this.#w?" filter--auto-submit":"";this.#t.innerHTML=`
		...
		`}#Z(){const e=this.getAttribute("label")||"Filters",n=this.#w?" filter--auto-submit":"";this.#t.innerHTML=`
		...
		`}#G(){if(!this.#g){this.#g=!0;try{const e=this.#t.querySelector(".filter__content");if(!e)return;if(this.#l.size===0){e.innerHTML='<p class="filter__empty">Geen filterbare gegevensbronnen gevonden.</p>';return}const n=[];this.#l.forEach((s,a)=>{let l=this.#_(a,s);if(l||(s.sources.forEach(({element:E,property:z})=>{E.data&&this.#M(E,z)}),l=this.#_(a,s)),!l||l.values.length===0){n.push(`
						<div class="filter__section" part="section" data-property="${this.#S(a)}">
							<h3 class="filter__section-title" part="section-title">${this.#O(s.label)}</h3>
							<p class="filter__loading">Loading data...</p>
						</div>
					`);return}const{values:h,valueType:c}=l,u=this.#T(a,l),m=s.collapsed,v=m?"false":"true",_=m?" hidden":"";if(u==="bool"){const E=this.#i[a]?.[0]==="1"?" checked":"",z=s.boolLabel||this.#x,R=this.#O(z),F=`
						<label class="filter__checkbox-label">
							<input
								type="checkbox"
								class="filter__checkbox"
								value="1"
								aria-label="${this.#O(`${s.label}: ${z}`)}"
								${E}
							>
						...
						<div class="filter__section filter__section--bool" part="section" data-property="${this.#S(a)}">
							${this.#D(s.label,a,v,_,F)}
						</div>
					`);return}if(u==="single"||c.single){n.push(`
						<div class="filter__section" part="section" data-property="${this.#S(a)}">
							${this.#D(s.label,a,v,_,`
								<p class="filter__single">Value: ${this.#O(String(h[0]))}</p>
							`)}
						</div>
					`);return}if(u==="range"){const E=this.#i[a]?.min??c.min,z=this.#i[a]?.max??c.max,R=`
						...
						<div class="filter__section" part="section" data-property="${this.#S(a)}">
							${this.#D(s.label,a,v,_,R)}
						</div>
					`);return}if(u==="checkbox"){const E=s.sources.reduce((F,{element:J})=>F||this.#ct(J),null),z=this.#y(a,s),R=h.map(F=>{const J=this.#at(a,F)?"checked":"",ot=this.#S(String(F)),et=this.#O(String(F)),St=z.get(String(F))||0,Q=St>0?` (${St})`:"",ht=E?.[F]?this.#dt(E[F]):this.#W();return`
							<label class="filter__checkbox-label">
								<input
									type="checkbox"
									class="filter__checkbox"
						...
						<fieldset class="filter__fieldset">
							<legend class="visually-hidden">${this.#O(s.label)}</legend>
							${R}
						</fieldset>`;n.push(`
						<div class="filter__section" part="section" data-property="${this.#S(a)}">
							${this.#D(s.label,a,v,_,j)}
						</div>
					`);return}const g=this.#i[a]||[],w=g.map(E=>{const z=this.#S(String(E)),R=this.#O(String(E));return`
					...
					`}).join(""),x=h.filter(E=>!g.includes(String(E))).map(E=>{const z=this.#S(String(E)),R=this.#O(String(E));return`
					...
					<div class="filter__section" part="section" data-property="${this.#S(a)}">
						${this.#D(s.label,a,v,_,C)}
					</div>
				`)}),e.innerHTML=n.join("")}finally{this.#g=!1}}}#D(e,n,s,a,l){if(this.#E){const h=`filter-section-${this.#S(n)}`;return`
				<button type="button" part="section-toggle" class="filter__section-toggle" aria-expanded="${s}" aria-controls="${h}">
					<span class="filter__section-toggle-text">${this.#O(e)}</span>
			...
			<h3 class="filter__section-title" part="section-title">${this.#O(e)}</h3>
			${l}`}#K(){return this.#m==="dialog"?this.#t.querySelector("dialog")?.open??!1:this.#f}#Q(){const e=this.#m,n=this.#t.querySelector(".filter__toggle");if(this.#G(),this.#B(),e==="dialog")this.#t.querySelector("dialog").showModal(),n.setAttribute("aria-expanded","true");else if(e==="dropdown"){const s=this.#t.querySelector(".filter__panel--dropdown"),a=()=>{const l=n.getBoundingClientRect(),h=this.closest("dm-map"),c=h?h.getBoundingClientRect():null;s.style.top=`${l.bottom+4}px`,c?(s.style.left=`${c.left}px`,s.style.right=`${window.innerWidth-c.right}px`,s.style.inlineSize="auto"):(s.style.left="",s.style.right=`${window.innerWidth-l.right}px`,s.style.inlineSize="")};a(),s.classList.add("filter__panel--open"),n.setAttribute("aria-expanded","true"),this.#f=!0,this.#u=a,window.addEventListener("scroll",this.#u,{passive:!0,capture:!0}),this.#c=l=>{l.composedPath().some(h=>h===s||h===n)||this.#R()},requestAnimationFrame(()=>{document.addEventListener("click",this.#c,!0)}),this.#t.addEventListener("keydown",this.#H)}else if(e==="sidebar"){const s=this.#t.querySelector(".filter__panel--sidebar"),a=this.#t.querySelector(".filter__overlay");s.classList.add("filter__panel--open"),a.classList.add("filter__overlay--visible"),n.setAttribute("aria-expanded","true"),this.#f=!0,this.#t.addEventListener("keydown",this.#H)}}#R(){const e=this.#m,n=this.#t.querySelector(".filter__toggle");if(e==="dialog")this.#t.querySelector("dialog").close();else if(e==="dropdown")this.#t.querySelector(".filter__panel--dropdown")?.classList.remove("filter__panel--open"),this.#f=!1,this.#u&&(window.removeEventListener("scroll",this.#u,{capture:!0}),this.#u=null),this.#c&&(document.removeEventListener("click",this.#c,!0),this.#c=null),this.#t.removeEventListener("keydown",this.#H);else if(e==="sidebar"){const s=this.#t.querySelector(".filter__panel--sidebar"),a=this.#t.querySelector(".filter__overlay");s?.classList.remove("filter__panel--open"),a?.classList.remove("filter__overlay--visible"),this.#f=!1,this.#t.removeEventListener("keydown",this.#H)}n.setAttribute("aria-expanded","false"),n.focus()}#H=e=>{e.key==="Escape"&&this.#R()};#Y(){this.#t.querySelector(".filter__toggle").addEventListener("click",()=>{this.#K()?this.#R():this.#Q()});const e=this.#t.querySelector('slot[name="header"]');if(e){const n=()=>{const s=e.assignedNodes().length>0;e.closest(".filter__header-text")?.classList.toggle("filter__header-text--empty",!s)};e.addEventListener("slotchange",n),n()}if(this.#t.querySelector(".filter__apply").addEventListener("click",()=>{this.#$(),this.#F(),this.#R()}),this.#t.querySelector(".filter__reset").addEventListener("click",()=>{this.#tt(),this.#R()}),this.#t.querySelector(".filter__close")?.addEventListener("click",()=>this.#R()),this.#m==="dialog"){const n=this.#t.querySelector("dialog");n.addEventListener("close",()=>{const s=this.#t.querySelector(".filter__toggle");s.setAttribute("aria-expanded","false"),s.focus()}),n.addEventListener("click",s=>{s.target===n&&this.#R()})}this.#m==="sidebar"&&this.#t.querySelector(".filter__overlay")?.addEventListener("click",()=>this.#R())}#U(e){const n=e.querySelector(".filter__custom-select-display"),s=e.querySelector(".filter__custom-select-dropdown");if(!n||!s)return;const a=n.getBoundingClientRect(),l=4,h=240,c=window.innerHeight,u=c-a.bottom-l,m=a.top-l,v=u<160&&m>u,_=v?m:u;s.style.left=`${a.left}px`,s.style.width=`${a.width}px`,s.style.maxBlockSize=`${Math.max(120,Math.min(h,_))}px`,v?(s.style.top="auto",s.style.bottom=`${c-a.top+l}px`):(s.style.bottom="auto",s.style.top=`${a.bottom+l}px`)}#B(){const e=this.#t.querySelector(".filter__content");if(!e)return;this.#p?.abort(),this.#p=new AbortController;const{signal:n}=this.#p,s=this.#w;e.querySelectorAll(".filter__section-toggle").forEach(a=>{a.addEventListener("click",()=>{const l=a.getAttribute("aria-expanded")==="true",h=a.getAttribute("aria-controls"),c=this.#t.getElementById(h);c&&(a.setAttribute("aria-expanded",l?"false":"true"),l?c.setAttribute("hidden",""):c.removeAttribute("hidden"))},{signal:n})}),e.querySelectorAll(".filter__checkbox").forEach(a=>{a.addEventListener("change",()=>{this.#$(),s?this.#F():this.#j()},{signal:n})}),e.querySelectorAll(".filter__custom-select").forEach(a=>{a.addEventListener("click",l=>{if(l.target.closest(".filter__chip-remove"))return;const h=a.getAttribute("aria-expanded")==="true";if(e.querySelectorAll(".filter__custom-select").forEach(c=>{c.setAttribute("aria-expanded","false")}),a.setAttribute("aria-expanded",h?"false":"true"),!h){this.#U(a);const c=a.querySelector(".filter__option");c&&setTimeout(()=>c.focus(),0)}},{signal:n}),a.addEventListener("keydown",l=>{if(l.key==="Enter"||l.key===" "){l.preventDefault();const h=a.getAttribute("aria-expanded")==="true";if(a.setAttribute("aria-expanded",h?"false":"true"),!h){this.#U(a);const c=a.querySelector(".filter__option");c&&setTimeout(()=>c.focus(),0)}}else if(l.key==="Escape")a.setAttribute("aria-expanded","false"),a.focus();else if(l.key==="ArrowDown"){l.preventDefault();const h=[...a.querySelectorAll(".filter__option")],c=h.indexOf(this.#t.activeElement);(h[c+1]||h[0])?.focus()}else if(l.key==="ArrowUp"){l.preventDefault();const h=[...a.querySelectorAll(".filter__option")],c=h.indexOf(this.#t.activeElement);(h[c-1]||h[h.length-1])?.focus()}},{signal:n})}),e.querySelectorAll(".filter__option").forEach(a=>{a.addEventListener("click",l=>{const c=l.target.closest(".filter__section").dataset.property,u=l.target.dataset.value;this.#i[c]||(this.#i[c]=[]),this.#i[c].push(u),this.#G(),this.#B(),s?this.#F():this.#j()},{signal:n}),a.addEventListener("keydown",l=>{l.key==="Enter"&&(l.preventDefault(),a.click())},{signal:n})}),e.querySelectorAll(".filter__chip-remove").forEach(a=>{a.addEventListener("click",l=>{l.stopPropagation();const h=l.target.closest(".filter__chip"),u=l.target.closest(".filter__section").dataset.property,m=h.dataset.value;this.#i[u]&&(this.#i[u]=this.#i[u].filter(v=>v!==m),this.#i[u].length===0&&delete this.#i[u]),this.#G(),this.#B(),s?this.#F():this.#j()},{signal:n})}),this.#t.addEventListener("click",a=>{a.composedPath().some(l=>l?.classList?.contains("filter__custom-select"))||e.querySelectorAll(".filter__custom-select").forEach(l=>{l.setAttribute("aria-expanded","false")})},{signal:n}),e.querySelectorAll(".filter__range-input").forEach(a=>{const l=a.closest(".filter__section")?.dataset.property||"unknown",h=this.#rt(()=>{this.#$(),s?this.#F():this.#j()},150,`range-${l}-${a.dataset.bound}`);a.addEventListener("input",c=>{const u=c.target.closest("label").querySelector("output");u&&(u.textContent=c.target.value),h()},{signal:n}),a.addEventListener("change",()=>{this.#$(),s?this.#F():this.#j()},{signal:n})})}#$(){const e={};this.#t.querySelectorAll(".filter__section").forEach(n=>{const s=n.dataset.property,a=n.querySelectorAll(".filter__checkbox");if(a.length>0){const c=Array.from(a).filter(u=>u.checked).map(u=>u.value);c.length>0&&(e[s]=c);return}const l=n.querySelectorAll(".filter__chip");if(l.length>0){const c=Array.from(l).map(u=>u.dataset.value);c.length>0&&(e[s]=c);return}if(n.querySelectorAll(".filter__range-input").length===2){const c=n.querySelector('[data-bound="min"]'),u=n.querySelector('[data-bound="max"]');c&&u&&(e[s]={min:Number(c.value),max:Number(u.value)})}}),this.#i=e,this.#d=!1}#j(){const e=this.#t.querySelector(".filter__apply");if(e){const n=JSON.stringify(this.#i)!==JSON.stringify(this.#a);e.classList.toggle("filter__apply--dirty",n)}}#F(){const e=new Map;this.#l.forEach((a,l)=>{const h=this.#i[l];a.sources.forEach(({element:c,property:u})=>{e.has(c)||e.set(c,{}),h!==void 0&&(e.get(c)[u]=h)})}),e.forEach((a,l)=>{l.dispatchEvent(new CustomEvent("dm-filter:apply",{bubbles:!1,detail:{filters:a}}))}),this.#a=JSON.parse(JSON.stringify(this.#i)),this.#et();const n=this.#t.querySelector(".filter__apply");n&&n.classList.remove("filter__apply--dirty");const s=Object.keys(this.#i).length;this.#rt(()=>{this.#st(s>0?`${s} filter${s!==1?"s":""} actief`:"Alle filters gewist")},500,"announce")()}#tt(){this.#i={},this.#d=!1;const e=new Set;this.#l.forEach(s=>{s.sources.forEach(({element:a})=>e.add(a))}),e.forEach(s=>{s.dispatchEvent(new CustomEvent("dm-filter:apply",{bubbles:!1,detail:{filters:{}}}))}),this.#a={},this.#et(),this.#st("Alle filters zijn gewist"),this.#G(),this.#B();const n=this.#t.querySelector(".filter__apply");n&&n.classList.remove("filter__apply--dirty")}#at(e,n){const s=this.#i[e];return!s||!Array.isArray(s)?!1:s.includes(String(n))}#et(){try{const e=new URL(window.location.href);Object.keys(this.#i).length===0?e.searchParams.delete("filters"):e.searchParams.set("filters",this.#ot(this.#i)),window.history.pushState({},"",e)}catch{}}#it(e=!1){try{const n=new URLSearchParams(window.location.search).get("filters");if(!n)return!1;const s=this.#lt(n);return this.#i=s,e&&this.#F(),!0}catch{return!1}}#ot(e){return btoa(encodeURIComponent(JSON.stringify(e)))}#lt(e){if(e.length>1e4)return{};const n=decodeURIComponent(atob(e));return this.#ht(JSON.parse(n))}#ht(e){if(typeof e!="object"||e===null||Array.isArray(e))return{};const n={};for(const[s,a]of Object.entries(e))Array.isArray(a)&&a.every(l=>typeof l=="string")?n[s]=a:a&&typeof a=="object"&&!Array.isArray(a)&&typeof a.min=="number"&&typeof a.max=="number"&&(n[s]={min:a.min,max:a.max});return n}#nt(e,n){const s=n-e;return s<=10?.1:s<=100?1:s<=1e3?10:100}#O(e){const n=document.createElement("div");return n.textContent=e,n.innerHTML}#S(e){return String(e).replace(/&/g,"&amp;").replace(/"/g,"&quot;").replace(/'/g,"&#39;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}#ct(e){const n=e.getAttribute("filter-icons");if(!n)return null;try{return JSON.parse(n)}catch{return null}}#W(){return`<svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
			<circle cx="10" cy="10" r="7" stroke="currentColor" stroke-width="1.5" fill="none"/>
		</svg>`}#dt(e){if(!e||typeof e!="string")return this.#W();try{const n=new DOMParser().parseFromString(e,"image/svg+xml");if(n.querySelector("parsererror"))return this.#W();const s=n.querySelector("svg");return s?(s.querySelectorAll("script, foreignObject, object, embed, iframe").forEach(a=>a.remove()),s.querySelectorAll("*").forEach(a=>{for(const l of[...a.attributes])(l.name.startsWith("on")||l.name==="href"||l.name==="xlink:href"||l.name.toLowerCase().includes("javascript"))&&a.removeAttribute(l.name)}),s.querySelectorAll("[href], [xlink\\:href]").forEach(a=>{const l=a.getAttribute("href")||a.getAttribute("xlink:href");l&&l.toLowerCase().includes("javascript:")&&a.remove()}),s.outerHTML):this.#W()}catch{return this.#W()}}#rt(e,n=150,s="default"){return(...a)=>{this.#s.has(s)&&clearTimeout(this.#s.get(s));const l=setTimeout(()=>{e.apply(this,a),this.#s.delete(s)},n);this.#s.set(s,l)}}#st(e){const n=this.#t.querySelector('[role="status"]');n&&(n.textContent="",setTimeout(()=>{n.textContent=e},100))}get activeFilterCount(){return Object.keys(this.#i).length}getFilterState(){return JSON.parse(JSON.stringify(this.#i))}resetFilters(){this.#tt()}exportFilters(){return JSON.stringify(this.#i)}disconnectedCallback(){this.#s.forEach(e=>clearTimeout(e)),this.#s.clear(),this.#p?.abort(),this.#p=null,this.#c&&(document.removeEventListener("click",this.#c,!0),this.#c=null),this.#v&&(window.removeEventListener("popstate",this.#v),this.#v=null),this.#e=[],this.#i={},this.#a={},this.#o.clear(),this.#l.clear(),this.#n=null}}return customElements.define("dm-filter",cu),Ge.ICON_SPRITE=jd,Ge.registerIcons=Ud,Ge.setIconSprite=Hd,Object.defineProperty(Ge,Symbol.toStringTag,{value:"Module"}),Ge})({});
