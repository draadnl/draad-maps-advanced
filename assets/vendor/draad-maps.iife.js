...
`;class tu extends HTMLElement{#t;#n=null;#e;#i=null;#a=null;#s=null;#o=-1;#r=[];#l=null;#h;#u;static get observedAttributes(){return["placeholder","label","search-properties","search-labels","radius","min-chars","debounce","address-filter"]}attributeChangedCallback(e,n,s){n!==s&&this.#n&&(this.#f(),Ut(this.#t),this.#_())}constructor(){super(),this.#t=this.attachShadow({mode:"open"}),this.#h=`search-input-${Math.random().toString(36).slice(2,9)}`,this.#u=`search-listbox-${Math.random().toString(36).slice(2,9)}`,this.#e=this.#d()}#d(){const e=new CSSStyleSheet;e.replaceSync(Yd),this.#t.adoptedStyleSheets=[e]}get placeholder(){return this.getAttribute("placeholder")||"Zoeken..."}set placeholder(e){this.setAttribute("placeholder",e)}get label(){return this.getAttribute("label")||"Zoek op straat, wijk of stadsdeel"}set label(e){this.setAttribute("label",e)}get searchProperties(){const e=this.getAttribute("search-properties");return e?e.split(",").map(n=>n.trim()).filter(n=>n):null}set searchProperties(e){Array.isArray(e)?this.setAttribute("search-properties",e.join(",")):this.setAttribute("search-properties",e)}get searchLabels(){const e=this.getAttribute("search-labels");return e?e.split(",").map(n=>n.trim()).filter(n=>n):null}set searchLabels(e){Array.isArray(e)?this.setAttribute("search-labels",e.join(",")):this.setAttribute("search-labels",e)}get radius(){const e=this.getAttribute("radius"),n=parseInt(e,10);return Number.isFinite(n)&&n>0?n:1e4}set radius(e){this.setAttribute("radius",String(e))}get minChars(){const e=this.getAttribute("min-chars"),n=parseInt(e,10);return Number.isFinite(n)&&n>=0?n:2}set minChars(e){this.setAttribute("min-chars",String(e))}get debounceDelay(){const e=this.getAttribute("debounce"),n=parseInt(e,10);return Number.isFinite(n)&&n>=0?n:300}set debounceDelay(e){this.setAttribute("debounce",String(e))}get addressFilter(){const e=this.getAttribute("address-filter");return e&&e.trim()?e.trim():null}set addressFilter(e){this.setAttribute("address-filter",e)}connectedCallback(){const e=this.closest("dm-map");e&&(e.map?this.#c(e):e.addEventListener("dm-map:ready",()=>{this.#c(e)},{once:!0}))}async#c(e){this.#n=e,await this.#e,this.#f(),Ut(this.#t),this.#_()}#f(){this.#t.innerHTML=`
		...
		`}#_(){const e=this.#t.querySelector(".search__input"),n=this.#t.querySelector(".search__button"),s=this.#t.querySelector(".search__clear"),a=this.#t.querySelector(".search__listbox");e.addEventListener("input",l=>this.#v(l)),e.addEventListener("keydown",l=>this.#y(l)),e.addEventListener("focus",()=>this.#A()),e.addEventListener("blur",l=>this.#p(l)),n.addEventListener("click",()=>this.#g()),s.addEventListener("click",()=>{e.value="",s.hidden=!0,this.#r=[],this.#k(),e.focus()}),a.addEventListener("mousedown",l=>{l.preventDefault()}),a.addEventListener("click",l=>{const h=l.target.closest('[role="option"]');if(h){const c=parseInt(h.dataset.index,10);this.#D(c)}})}#v(e){const n=e.target.value.trim(),s=this.#t.querySelector(".search__clear");if(s&&(s.hidden=!e.target.value),this.#s&&(clearTimeout(this.#s),this.#s=null),this.#R(),n.length<this.minChars){this.#r=[],this.#k();return}this.#s=setTimeout(()=>{this.#M(n)},this.debounceDelay)}#y(e){const s=!this.#t.querySelector(".search__listbox").hidden;switch(e.key){case"ArrowDown":e.preventDefault(),s&&this.#F(1);break;case"ArrowUp":e.preventDefault(),s&&this.#F(-1);break;case"Enter":if(e.preventDefault(),s&&this.#r.length>0){const a=this.#o>=0?this.#o:0;this.#D(a)}else this.#L();break;case"Escape":e.preventDefault(),this.#k();break;case"Tab":this.#k();break}}#A(){this.#r.length>0&&this.#V()}#p(e){this.#a=setTimeout(()=>{this.#k()},150)}#g(){if(this.#r.length>0){const e=this.#o>=0?this.#o:0;this.#D(e)}else this.#L()}#L(){const n=this.#t.querySelector(".search__input").value.trim();n.length>=this.minChars&&this.#M(n)}async#M(e){this.#i&&this.#i.abort(),this.#i=new AbortController,this.#J(!0);try{const[n,s]=await Promise.all([this.#b(e),this.#w(e,this.#i.signal)]),a=s?.error===!0,l=a?s.results:s;this.#r=[...n.slice(0,5),...l.slice(0,10)],this.#N(a),this.#V();const h=this.#r.length;let c=h>0?`${h} resultaat${h!==1?"en":""} gevonden`:"Geen resultaten gevonden";a&&(c+=". Zoeken in adressen niet beschikbaar"),this.#H(c)}catch(n){n.name!=="AbortError"&&this.#H("Er is een fout opgetreden bij het zoeken")}finally{this.#J(!1)}}async#w(e,n){const s=new URL("https://api.pdok.nl/bzk/locatieserver/search/v3_1/free");s.searchParams.set("q",e),s.searchParams.set("rows","10"),s.searchParams.set("fq","type:(provincie OR gemeente OR woonplaats OR wijk OR buurt OR weg OR adres)"),this.addressFilter&&s.searchParams.append("fq",this.addressFilter),s.searchParams.set("fl","id,weergavenaam,type,score,centroide_ll,geometrie_ll");try{const a=await fetch(s.toString(),{signal:n});if(!a.ok)throw new Error(`HTTP ${a.status}`);return((await a.json()).response?.docs||[]).map(c=>({type:"address",label:c.weergavenaam,subtype:c.type,coordinates:this.#P(c.centroide_ll),geometry:c.geometrie_ll?this.#C(c.geometrie_ll):null,bounds:null,raw:c}))}catch(a){if(a.name==="AbortError")throw a;return{error:!0,results:[]}}}#b(e){const n=[],s=e.toLowerCase(),a=this.searchProperties,l=this.#n.querySelectorAll("dm-geojson, dm-wfs");for(const c of l){if(n.length>=5)break;const u=c.data;if(!u?.features)continue;const m=c.geoJsonLayer||c.wfsLayer;if(m)for(const v of u.features){if(n.length>=5)break;const g=v.properties||{},_=this.#S(g,s,a);if(_.length>0){const{label:w,matchedProperty:x}=this.#m(g,_);n.push({type:"feature",label:w,subtype:x,feature:v,layer:m,bounds:this.#E(v,m),coordinates:this.#z(v,m),source:c})}}}const h=this.#n.querySelectorAll("dm-marker[label]");for(const c of h){if(n.length>=5)break;const u=c.label;if(u&&u.toLowerCase().includes(s)){const m=c.center;if(!m)continue;n.push({type:"marker",label:u,subtype:"marker",coordinates:m,bounds:null,marker:c})}}return n}#S(e,n,s){const a=[];for(const[l,h]of Object.entries(e))s&&!s.includes(l)||typeof h=="string"&&h.toLowerCase().includes(n)&&a.push({key:l,value:h});return a}#m(e,n){const s=n[0],a=this.searchLabels,l=this.searchProperties;let h=s.key;if(l&&a){const c=l.indexOf(s.key);c>=0&&a[c]&&(h=a[c])}return{label:s.value,matchedProperty:h}}#E(e,n){const s=e.geometry;if(!s||s.type==="Point")return null;try{let l=null;if(n.eachLayer(h=>{h.feature===e&&(l=h)}),l&&l.getBounds)return l.getBounds()}catch{}return null}#z(e,n){const s=e.geometry;if(!s)return null;const a=s.type,l=s.coordinates;if(a==="Point")return[l[1],l[0]];try{let h=null;if(n.eachLayer(c=>{c.feature===e&&(h=c)}),h){if(h.getBounds){const c=h.getBounds().getCenter();return[c.lat,c.lng]}if(h.getLatLng){const c=h.getLatLng();return[c.lat,c.lng]}}}catch{}return null}#P(e){if(!e)return null;const n=e.match(/POINT\s*\(\s*([\d.-]+)\s+([\d.-]+)\s*\)/i);if(!n)return null;const s=parseFloat(n[1]),a=parseFloat(n[2]);return isNaN(a)||isNaN(s)?null:[a,s]}#C(e){if(!e)return null;const n=e.match(/^(\w+)/i);if(!n)return null;const s=n[1].toUpperCase();try{if(s==="POLYGON"||s==="MULTIPOLYGON")return this.#q(e,s);if(s==="LINESTRING"||s==="MULTILINESTRING")return this.#j(e,s);if(s==="POINT"){const a=this.#P(e);return a?{type:"Point",coordinates:[a[1],a[0]]}:null}}catch{}return null}#q(e,n){const s=[],a=/\(\s*([\d.\s,-]+)\s*\)/g;let l;for(;(l=a.exec(e))!==null;){const h=l[1].split(",").map(c=>{const[u,m]=c.trim().split(/\s+/).map(parseFloat);return[m,u]});h.length>0&&s.push(h)}return s.length===0?null:{type:n==="MULTIPOLYGON"?"MultiPolygon":"Polygon",coordinates:s}}#j(e,n){const s=[];if(n==="LINESTRING"){const a=e.match(/LINESTRING\s*\(\s*([\d.\s,-]+)\s*\)/i);if(a){const l=a[1].split(",").map(h=>{const[c,u]=h.trim().split(/\s+/).map(parseFloat);return[u,c]});s.push(l)}}else{const a=/\(\s*([\d.\s,-]+)\s*\)/g;let l;for(;(l=a.exec(e))!==null;){const h=l[1].split(",").map(c=>{const[u,m]=c.trim().split(/\s+/).map(parseFloat);return[m,u]});h.length>0&&s.push(h)}}return s.length===0?null:{type:n==="MULTILINESTRING"?"MultiLineString":"LineString",coordinates:s}}#I(e){if(e.type==="address"&&e.subtype){const n=e.subtype.toLowerCase();if(n==="provincie")return 5e4;if(n==="gemeente")return 2e4;if(n==="woonplaats")return 15e3;if(n==="wijk"||n==="buurt")return 3e3;if(n==="weg")return 5e3}return this.radius}#N(e=!1){const n=this.#t.querySelector(".search__listbox"),s=this.#t.querySelector(".search__input");if(this.#r.length===0){n.innerHTML=`
			...
			`,this.#o=-1;return}let a="";e&&(a='<li class="search__no-results" part="no-results" role="option" aria-disabled="true">Zoeken in adressen niet beschikbaar</li>');const l=this.#r.filter(v=>v.type==="feature"||v.type==="marker"),h=this.#r.filter(v=>v.type==="address"),c=l.length>0&&h.length>0,u=(v,g)=>{const _=g===this.#o;return`
				<li
					id="search-option-${g}"
...
`;class cu extends HTMLElement{#t;#n=null;#e=[];#i={};#a={};#s=new Map;#o=new WeakMap;#r=new Map;#l=new Map;#h;#u=!1;#d=!1;#c=null;#f=null;#_=null;#v=!1;#y=null;constructor(){super(),this.#t=this.attachShadow({mode:"open"}),this.#h=this.#A()}#A(){const e=new CSSStyleSheet;e.replaceSync(hu),this.#t.adoptedStyleSheets=[e]}get#p(){const e=this.getAttribute("variant");return e==="dropdown"||e==="sidebar"?e:"dialog"}get#g(){return(this.getAttribute("submit")||"auto")==="auto"}get#L(){return this.hasAttribute("collapsible")}connectedCallback(){const e=this.closest("dm-map");e&&(e.map?this.#M(e):e.addEventListener("dm-map:ready",()=>{this.#M(e)},{once:!0}))}async#M(e){if(this.#n=e,await this.#h,this.#w(),this.#b(),this.#j(),Ut(this.#t),this.#J(),this.#k(),this.#T(),this.hasAttribute("open")&&this.#p==="sidebar"){const s=this.#t.querySelector(".filter__panel--sidebar"),a=this.#t.querySelector(".filter__toggle");s?.classList.add("filter__panel--open"),a?.setAttribute("aria-expanded","true"),this.#d=!0}this.#tt()&&(this.#u=!0,this.#a=JSON.parse(JSON.stringify(this.#i))),this.#y=()=>this.#tt(!0),window.addEventListener("popstate",this.#y)}#w(){const e=["dm-geojson[filter-property], dm-geojson[filter-properties]","dm-wfs[filter-property], dm-wfs[filter-properties]","dm-layer[filter-property], dm-layer[filter-properties]"];this.#e=[],e.forEach(n=>{this.#n.querySelectorAll(n).forEach(s=>{const a=s.getAttribute("filter-properties"),l=s.getAttribute("filter-labels"),h=s.getAttribute("filter-property"),c=s.getAttribute("filter-label"),u=s.getAttribute("filter-types"),m=s.getAttribute("filter-collapsed");let v=[],g=[],_=[],w=[];if(a){for(v=a.split(",").map(E=>E.trim()).filter(Boolean),l&&(g=l.split(",").map(E=>E.trim()).filter(Boolean)),u&&(_=u.split(",").map(E=>E.trim()).filter(Boolean)),m&&(w=m.split(",").map(E=>E.trim()).filter(Boolean));g.length<v.length;)g.push(v[g.length]);for(;_.length<v.length;)_.push("auto");for(;w.length<v.length;)w.push("false")}else h&&(v=[h],g=[c||h],_=[u||"auto"],w=[m||"false"]);if(v.length===0)return;const x=s.id||`filter-source-${this.#e.length}`,S=s.getAttribute("filter-key");if(v.forEach((E,C)=>{this.#e.push({element:s,label:g[C],property:E,groupKey:S||E,type:s.tagName.toLowerCase(),id:x,filterType:_[C]||"auto",collapsed:w[C]==="true"})}),!this.#o.has(s))if(this.#o.set(s,!0),s.data)v.forEach(E=>{this.#m(s,E)});else{const E=s.tagName==="DM-GEOJSON"?"dm-geojson:ready":s.tagName==="DM-WFS"?"dm-wfs:ready":"dm-layer:ready";let C=!1;s.addEventListener(E,()=>{C||(C=!0,v.forEach(k=>{this.#m(s,k)}),this.#b(),this.#k(),this.#T())},{once:!0}),s.data&&!C&&(C=!0,v.forEach(k=>{this.#m(s,k)}))}})})}#b(){this.#l=new Map,this.#e.forEach(e=>{this.#l.has(e.groupKey)||this.#l.set(e.groupKey,{label:e.label,filterType:e.filterType,collapsed:e.collapsed,sources:[]});const n=this.#l.get(e.groupKey);n.sources.find(a=>a.element===e.element&&a.property===e.property)||n.sources.push({element:e.element,id:e.id,property:e.property})})}#S(e,n){const s=new Set;if(n.sources.forEach(({id:l,property:h})=>{const c=`${l}:${h}`,u=this.#s.get(c);u&&u.values.forEach(m=>s.add(m))}),s.size===0)return null;const a=Array.from(s).sort((l,h)=>typeof l=="number"&&typeof h=="number"?l-h:String(l).localeCompare(String(h)));return{values:a,valueType:this.#P(a)}}#m(e,n){const s=this.#E(e,n),a=this.#P(s),l=this.#e.find(c=>c.element===e&&c.property===n);if(!l)return;const h=`${l.id}:${n}`;this.#s.set(h,{values:s,valueType:a}),this.#u&&Object.keys(this.#i).length>0&&this.#B(),this.#D()&&(this.#k(),this.#T())}#E(e,n){if(!e.data?.features)return[];const s=new Set;return e.data.features.forEach(a=>{const l=a.properties?.[n];if(l!=null){const h=String(l);h.includes(",")?h.split(",").forEach(c=>{const u=c.trim();u&&s.add(u)}):s.add(l)}}),Array.from(s).sort((a,l)=>typeof a=="number"&&typeof l=="number"?a-l:String(a).localeCompare(String(l)))}#z(e,n){const s=new Map;return n.sources.forEach(({element:a,property:l})=>{a.data?.features&&a.data.features.forEach(h=>{const c=h.properties?.[l];if(c==null)return;const u=String(c);(u.includes(",")?u.split(",").map(v=>v.trim()).filter(Boolean):[u]).forEach(v=>{s.set(v,(s.get(v)||0)+1)})})}),s}#P(e){if(e.length===0)return{isNumeric:!1};if(e.length===1)return{isNumeric:!1,single:!0};if(e.every(s=>typeof s=="number"?!0:typeof s=="string"?!isNaN(Number(s))&&s.trim()!=="":!1)){const s=e.map(a=>Number(a));return{isNumeric:!0,min:Math.min(...s),max:Math.max(...s)}}return{isNumeric:!1}}#C(e,n){const s=this.#l.get(e)?.filterType;return s&&s!=="auto"?s==="range"&&!n.valueType.isNumeric?this.#q(n):s:this.#q(n)}#q({values:e,valueType:n}){return n.isNumeric&&!n.single?"range":e.length<=20?"checkbox":"dropdown"}#j(){const e=this.#p;e==="dropdown"?this.#K():e==="sidebar"?this.#V():this.#W()}#I(){return`
		...
		`}#k(){if(!this.#v){this.#v=!0;try{const e=this.#t.querySelector(".filter__content");if(!e)return;if(this.#l.size===0){e.innerHTML='<p class="filter__empty">Geen filterbare gegevensbronnen gevonden.</p>';return}const n=[];this.#l.forEach((s,a)=>{let l=this.#S(a,s);if(l||(s.sources.forEach(({element:k,property:I})=>{k.data&&this.#m(k,I)}),l=this.#S(a,s)),!l||l.values.length===0){n.push(`
					...
					`);return}if(u==="checkbox"){const k=s.sources.reduce((F,{element:J})=>F||this.#lt(J),null),I=this.#z(a,s),B=h.map(F=>{const J=this.#rt(a,F)?"checked":"",ot=this.#x(String(F)),et=this.#O(String(F)),Mt=I.get(String(F))||0,Q=Mt>0?` (${Mt})`:"",ht=k?.[F]?this.#ht(k[F]):this.#$();return`
					...
					`);return}const _=this.#i[a]||[],w=_.map(k=>{const I=this.#x(String(k)),B=this.#O(String(k));return`
					...
					`}).join(""),x=h.filter(k=>!_.includes(String(k))).map(k=>{const I=this.#x(String(k)),B=this.#O(String(k));return`
