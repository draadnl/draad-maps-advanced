...
`;class tu extends HTMLElement{#t;#n=null;#e;#i=null;#a=null;#l=null;#r=-1;#s=[];#o=null;#h=null;#d;#u;static get observedAttributes(){return["placeholder","label","search-properties","search-labels","radius","min-chars","debounce","address-filter"]}attributeChangedCallback(e,n,s){n!==s&&this.#n&&(this.#m(),Ut(this.#t),this.#v())}constructor(){super(),this.#t=this.attachShadow({mode:"open"}),this.#d=`search-input-${Math.random().toString(36).slice(2,9)}`,this.#u=`search-listbox-${Math.random().toString(36).slice(2,9)}`,this.#e=this.#c()}#c(){const e=new CSSStyleSheet;e.replaceSync(Yd),this.#t.adoptedStyleSheets=[e]}get placeholder(){return this.getAttribute("placeholder")||"Zoeken..."}set placeholder(e){this.setAttribute("placeholder",e)}get label(){return this.getAttribute("label")||"Zoek op straat, wijk of stadsdeel"}set label(e){this.setAttribute("label",e)}get searchProperties(){const e=this.getAttribute("search-properties");return e?e.split(",").map(n=>n.trim()).filter(n=>n):null}set searchProperties(e){Array.isArray(e)?this.setAttribute("search-properties",e.join(",")):this.setAttribute("search-properties",e)}get searchLabels(){const e=this.getAttribute("search-labels");return e?e.split(",").map(n=>n.trim()).filter(n=>n):null}set searchLabels(e){Array.isArray(e)?this.setAttribute("search-labels",e.join(",")):this.setAttribute("search-labels",e)}get radius(){const e=this.getAttribute("radius"),n=parseInt(e,10);return Number.isFinite(n)&&n>0?n:1e4}set radius(e){this.setAttribute("radius",String(e))}get minChars(){const e=this.getAttribute("min-chars"),n=parseInt(e,10);return Number.isFinite(n)&&n>=0?n:2}set minChars(e){this.setAttribute("min-chars",String(e))}get debounceDelay(){const e=this.getAttribute("debounce"),n=parseInt(e,10);return Number.isFinite(n)&&n>=0?n:300}set debounceDelay(e){this.setAttribute("debounce",String(e))}get addressFilter(){const e=this.getAttribute("address-filter");return e&&e.trim()?e.trim():null}set addressFilter(e){this.setAttribute("address-filter",e)}connectedCallback(){const e=this.closest("dm-map");e&&(e.map?this.#f(e):e.addEventListener("dm-map:ready",()=>{this.#f(e)},{once:!0}))}async#f(e){this.#n=e,await this.#e,this.#m(),Ut(this.#t),this.#v()}#m(){this.#t.innerHTML=`
				...
				<div class="search__form" part="form" role="search">
					<div class="search__input-wrapper" part="input-wrapper">
						<input
							...
							class="search__input"
							part="input"
							placeholder="${this.#Q(this.placeholder)}"
							maxlength="200"
							autocomplete="off"
		...
		`}#v(){const e=this.#t.querySelector(".search__input"),n=this.#t.querySelector(".search__button"),s=this.#t.querySelector(".search__clear"),a=this.#t.querySelector(".search__listbox");e.addEventListener("input",l=>this.#y(l)),e.addEventListener("keydown",l=>this.#A(l)),e.addEventListener("focus",()=>this.#p()),e.addEventListener("blur",l=>this.#b(l)),n.addEventListener("click",()=>this.#P()),s.addEventListener("click",()=>{e.value="",s.hidden=!0,this.#s=[],this.#z(),e.focus()}),a.addEventListener("mousedown",l=>{l.preventDefault()}),a.addEventListener("click",l=>{const h=l.target.closest('[role="option"]');if(h){const c=parseInt(h.dataset.index,10);this.#$(c)}})}#y(e){const n=e.target.value.trim(),s=this.#t.querySelector(".search__clear");if(s&&(s.hidden=!e.target.value),this.#l&&(clearTimeout(this.#l),this.#l=null),this.#D(),n.length<this.minChars){this.#s=[],this.#z();return}this.#l=setTimeout(()=>{this.#_(n)},this.debounceDelay)}#A(e){const s=!this.#t.querySelector(".search__listbox").hidden;switch(e.key){case"ArrowDown":e.preventDefault(),s&&this.#U(1);break;case"ArrowUp":e.preventDefault(),s&&this.#U(-1);break;case"Enter":if(e.preventDefault(),s&&this.#s.length>0){const a=this.#r>=0?this.#r:0;this.#$(a)}else this.#x();break;case"Escape":e.preventDefault(),this.#z();break;case"Tab":this.#z();break}}#p(){this.#s.length>0&&this.#N()}#b(e){this.#a=setTimeout(()=>{this.#z()},150)}#P(){if(this.#s.length>0){const e=this.#r>=0?this.#r:0;this.#$(e)}else this.#x()}#x(){const n=this.#t.querySelector(".search__input").value.trim();n.length>=this.minChars&&this.#_(n)}async#_(e){this.#i&&this.#i.abort(),this.#i=new AbortController,this.#Z(!0);try{const[n,s]=await Promise.all([this.#L(e),this.#C(e,this.#i.signal)]),a=s?.error===!0,l=a?s.results:s;this.#s=[...n.slice(0,5),...l.slice(0,10)],this.#j(a),this.#N();const h=this.#s.length;let c=h>0?`${h} resultaat${h!==1?"en":""} gevonden`:"Geen resultaten gevonden";a&&(c+=". Zoeken in adressen niet beschikbaar"),this.#I(c)}catch(n){n.name!=="AbortError"&&this.#I("Er is een fout opgetreden bij het zoeken")}finally{this.#Z(!1)}}async#C(e,n){const s=new URL("https://api.pdok.nl/bzk/locatieserver/search/v3_1/free");s.searchParams.set("q",e),s.searchParams.set("rows","10"),s.searchParams.set("fq","type:(provincie OR gemeente OR woonplaats OR wijk OR buurt OR weg OR adres)"),this.addressFilter&&s.searchParams.append("fq",this.addressFilter),s.searchParams.set("fl","id,weergavenaam,type,score,centroide_ll,geometrie_ll");try{const a=await fetch(s.toString(),{signal:n});if(!a.ok)throw new Error(`HTTP ${a.status}`);return((await a.json()).response?.docs||[]).map(c=>({type:"address",label:c.weergavenaam,subtype:c.type,coordinates:this.#M(c.centroide_ll),geometry:c.geometrie_ll?this.#O(c.geometrie_ll):null,bounds:null,raw:c}))}catch(a){if(a.name==="AbortError")throw a;return{error:!0,results:[]}}}#L(e){const n=[],s=e.toLowerCase(),a=this.searchProperties,l=this.#n.querySelectorAll("dm-geojson, dm-wfs");for(const c of l){if(n.length>=5)break;const u=c.data;if(!u?.features)continue;const m=c.geoJsonLayer||c.wfsLayer;if(m)for(const v of u.features){if(n.length>=5)break;const g=v.properties||{},_=this.#w(g,s,a);if(_.length>0){const{label:w,matchedProperty:x}=this.#S(g,_);n.push({type:"feature",label:w,subtype:x,feature:v,layer:m,bounds:this.#k(v,m),coordinates:this.#g(v,m),source:c})}}}const h=this.#n.querySelectorAll("dm-marker[label]");for(const c of h){if(n.length>=5)break;const u=c.label;if(u&&u.toLowerCase().includes(s)){const m=c.center;if(!m)continue;n.push({type:"marker",label:u,subtype:"marker",coordinates:m,bounds:null,marker:c})}}return n}#w(e,n,s){const a=[];for(const[l,h]of Object.entries(e))s&&!s.includes(l)||typeof h=="string"&&h.toLowerCase().includes(n)&&a.push({key:l,value:h});return a}#S(e,n){const s=n[0],a=this.searchLabels,l=this.searchProperties;let h=s.key;if(l&&a){const c=l.indexOf(s.key);c>=0&&a[c]&&(h=a[c])}return{label:s.value,matchedProperty:h}}#k(e,n){const s=e.geometry;if(!s||s.type==="Point")return null;try{let l=null;if(n.eachLayer(h=>{h.feature===e&&(l=h)}),l&&l.getBounds)return l.getBounds()}catch{}return null}#g(e,n){const s=e.geometry;if(!s)return null;const a=s.type,l=s.coordinates;if(a==="Point")return[l[1],l[0]];try{let h=null;if(n.eachLayer(c=>{c.feature===e&&(h=c)}),h){if(h.getBounds){const c=h.getBounds().getCenter();return[c.lat,c.lng]}if(h.getLatLng){const c=h.getLatLng();return[c.lat,c.lng]}}}catch{}return null}#M(e){if(!e)return null;const n=e.match(/POINT\s*\(\s*([\d.-]+)\s+([\d.-]+)\s*\)/i);if(!n)return null;const s=parseFloat(n[1]),a=parseFloat(n[2]);return isNaN(a)||isNaN(s)?null:[a,s]}#O(e){if(!e)return null;const n=e.match(/^(\w+)/i);if(!n)return null;const s=n[1].toUpperCase();try{if(s==="POLYGON"||s==="MULTIPOLYGON")return this.#G(e,s);if(s==="LINESTRING"||s==="MULTILINESTRING")return this.#T(e,s);if(s==="POINT"){const a=this.#M(e);return a?{type:"Point",coordinates:[a[1],a[0]]}:null}}catch{}return null}#G(e,n){const s=[],a=/\(\s*([\d.\s,-]+)\s*\)/g;let l;for(;(l=a.exec(e))!==null;){const h=l[1].split(",").map(c=>{const[u,m]=c.trim().split(/\s+/).map(parseFloat);return[m,u]});h.length>0&&s.push(h)}return s.length===0?null:{type:n==="MULTIPOLYGON"?"MultiPolygon":"Polygon",coordinates:s}}#T(e,n){const s=[];if(n==="LINESTRING"){const a=e.match(/LINESTRING\s*\(\s*([\d.\s,-]+)\s*\)/i);if(a){const l=a[1].split(",").map(h=>{const[c,u]=h.trim().split(/\s+/).map(parseFloat);return[u,c]});s.push(l)}}else{const a=/\(\s*([\d.\s,-]+)\s*\)/g;let l;for(;(l=a.exec(e))!==null;){const h=l[1].split(",").map(c=>{const[u,m]=c.trim().split(/\s+/).map(parseFloat);return[m,u]});h.length>0&&s.push(h)}}return s.length===0?null:{type:n==="MULTILINESTRING"?"MultiLineString":"LineString",coordinates:s}}#q(e){if(e.type==="address"&&e.subtype){const n=e.subtype.toLowerCase();if(n==="provincie")return 5e4;if(n==="gemeente")return 2e4;if(n==="woonplaats")return 15e3;if(n==="wijk"||n==="buurt")return 3e3;if(n==="weg")return 5e3}return this.radius}#j(e=!1){const n=this.#t.querySelector(".search__listbox"),s=this.#t.querySelector(".search__input");if(this.#s.length===0){n.innerHTML=`
			...
			`,this.#r=-1;return}let a="";e&&(a='<li class="search__no-results" part="no-results" role="option" aria-disabled="true">Zoeken in adressen niet beschikbaar</li>');const l=this.#s.filter(v=>v.type==="feature"||v.type==="marker"),h=this.#s.filter(v=>v.type==="address"),c=l.length>0&&h.length>0,u=(v,g)=>{const _=g===this.#r;return`
				<li
					id="search-option-${g}"
				...
				>
					...
					<span class="search__result-label">${this.#V(v.label)}</span>
				</li>
			`};let m="";c?(m+='<li class="search__group-label" part="group-label" role="presentation">Op de kaart</li>',m+=l.map(v=>u(v,this.#s.indexOf(v))).join(""),m+='<li class="search__group-label" part="group-label" role="presentation">Adressen</li>',m+=h.map(v=>u(v,this.#s.indexOf(v))).join("")):m+=this.#s.map((v,g)=>u(v,g)).join(""),n.innerHTML=m+a,this.#r>=0?s.setAttribute("aria-activedescendant",`search-option-${this.#r}`):s.removeAttribute("aria-activedescendant")}#Y(e){switch(e.type){case"address":return e.subtype||"Adres";case"feature":return e.subtype||"Object";case"marker":return"Marker";default:return""}}#K(e){switch(e.type){case"address":return'<svg aria-hidden="true" width="20" height="20"><use href="#icon-map-pin"/></svg>';case"feature":return'<svg aria-hidden="true" width="20" height="20"><use href="#icon-hamburger"/></svg>';case"marker":return'<svg aria-hidden="true" width="20" height="20"><use href="#icon-map-pin"/></svg>';default:return""}}#N(){const e=this.#t.querySelector(".search__listbox"),n=this.#t.querySelector(".search__input"),s=this.#t.querySelector(".search__form");e.hidden=!1,n.setAttribute("aria-expanded","true"),s.dataset.open="true"}#z(){const e=this.#t.querySelector(".search__listbox"),n=this.#t.querySelector(".search__input"),s=this.#t.querySelector(".search__form");e.hidden=!0,n.setAttribute("aria-expanded","false"),n.removeAttribute("aria-activedescendant"),this.#r=-1,delete s.dataset.open}#U(e){const n=this.#s.length-1;if(n<0)return;this.#r+=e,this.#r<0?this.#r=n:this.#r>n&&(this.#r=0),this.#j();const s=this.#t.querySelector(`#search-option-${this.#r}`);s&&s.scrollIntoView({block:"nearest"})}#$(e){const n=this.#s[e];if(!n)return;const s=this.#t.querySelector(".search__input"),a=this.#t.querySelector(".search__clear");s.value=n.label,a&&(a.hidden=!n.label),this.#z(),this.#R(n),this.#B(n),this.dispatchEvent(new CustomEvent("dm-search:select",{bubbles:!0,composed:!0,detail:{type:n.type,label:n.label,coordinates:n.coordinates,bounds:n.bounds,feature:n.feature,marker:n.marker,raw:n.raw}}))}#R(e){const n=this.#n.map;if(!n)return;this.#D();const s=e.geometry?.type||"";s.includes("Polygon")||s.includes("Line")?this.#H(e):e.type==="address"&&e.coordinates&&this.#X(e.coordinates);let a;if(this.#o?.getBounds)a=this.#o.getBounds();else if(e.bounds)a=e.bounds;else if(e.coordinates){const l=G.latLng(e.coordinates[0],e.coordinates[1]),h=this.#q(e);a=l.toBounds(h)}a&&(n.fitBounds(a,{padding:[40,40]}),this.dispatchEvent(new CustomEvent("dm-search:zoom",{bubbles:!0,composed:!0,detail:{bounds:a,result:e}})))}#H(e){const n=this.#n.map;if(!n||!e.geometry)return;const s=e.geometry,a=s.type==="LineString"||s.type==="MultiLineString",l=this.#W(),h={color:l,weight:a?4:2,opacity:.8,fillColor:l,fillOpacity:a?0:.15};s.type==="Polygon"||s.type==="MultiPolygon"?this.#o=G.polygon(s.coordinates,h):s.type==="LineString"?this.#o=G.polyline(s.coordinates[0],h):s.type==="MultiLineString"&&(this.#o=G.polyline(s.coordinates,h)),this.#o&&this.#o.addTo(n)}#X(e){const n=this.#n?.map;!n||!e||(this.#o=G.circleMarker(e,{radius:9,color:"#fff",weight:2,fillColor:this.#W(),fillOpacity:1,opacity:1}).addTo(n))}#W(){const e=getComputedStyle(this);return e.getPropertyValue("--draad-map-components-search-highlight-color").trim()||e.getPropertyValue("--draad-map-components-color-primary").trim()||"#268641"}#B(e){if(e.type==="marker"&&e.marker)e.marker.active=!0,e.marker.marker?.setZIndexOffset?.(1e3),this.#h=e.marker,e.marker.dispatchEvent(new CustomEvent("dm-marker:click",{bubbles:!0,composed:!0,detail:{marker:e.marker.marker??null,targetId:e.marker.target}}));else if(e.type==="feature"&&e.source){const n=e.source.tagName==="DM-WFS"?"wfs":"geojson";e.source.dispatchEvent(new CustomEvent(`dm-${n}:feature-click`,{bubbles:!0,composed:!0,detail:{feature:e.feature,layer:e.layer,latlng:null}}))}}#D(){this.#o&&this.#n?.map&&(this.#n.map.removeLayer(this.#o),this.#o=null),this.#n?.querySelectorAll("dm-geojson, dm-wfs").forEach(e=>e.clearActiveFeature?.()),this.#h&&(this.#h.active=!1,this.#h.marker?.setZIndexOffset?.(0),this.#h=null)}#Z(e){const n=this.#t.querySelector(".search__button");e?(n.classList.add("search__button--loading"),n.setAttribute("aria-busy","true")):(n.classList.remove("search__button--loading"),n.removeAttribute("aria-busy"))}#I(e){const n=this.#t.querySelector('[role="status"]');n&&(n.textContent="",setTimeout(()=>{n.textContent=e},100))}#V(e){const n=document.createElement("div");return n.textContent=e,n.innerHTML}#Q(e){return String(e).replace(/&/g,"&amp;").replace(/"/g,"&quot;").replace(/'/g,"&#39;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}disconnectedCallback(){this.#i&&(this.#i.abort(),this.#i=null),this.#a&&(clearTimeout(this.#a),this.#a=null),this.#l&&(clearTimeout(this.#l),this.#l=null),this.#D(),this.#n=null,this.#s=[]}}customElements.define("dm-search",tu);const eu=`/* dm-infowindow - Card panel styling */
:host {
	display: flex;
	flex-direction: column;
	max-block-size: 100%;
...
`;class iu extends HTMLElement{#t;#n=null;#e=null;#i=null;#a=null;#l=null;#r=null;#s=null;#o=null;#h=null;#d=!1;#u;constructor(){super(),this.#t=this.attachShadow({mode:"open"}),this.#u=this.#c()}#c(){const e=new CSSStyleSheet;e.replaceSync(eu),this.#t.adoptedStyleSheets=[e]}static get observedAttributes(){return["for","feature-id","trigger"]}get for(){return this.getAttribute("for")}set for(e){this.setAttribute("for",e)}get featureId(){return this.getAttribute("feature-id")}set featureId(e){this.setAttribute("feature-id",e)}get trigger(){return this.getAttribute("trigger")||"click"}set trigger(e){this.setAttribute("trigger",e)}get isOpen(){return this.#d}connectedCallback(){const e=this.closest("dm-map");e&&(this.#n=e,this.setAttribute("slot","top-right"),this.#v(),this.setAttribute("hidden",""),Ut(this.#t),e.map?this.#f():e.addEventListener("dm-map:ready",()=>{this.#f()},{once:!0}))}async#f(){await this.#u,this.#y(),this.#l=e=>this.#m(e),this.#n.addEventListener("dm-infowindow:open",this.#l)}#m(e){e.target!==this&&this.isOpen&&this.close()}#v(){this.#t.innerHTML=`
...
`;class cu extends HTMLElement{#t;#n=null;#e=[];#i={};#a={};#l=new Map;#r=new WeakMap;#s=new Map;#o=new Map;#h;#d=!1;#u=!1;#c=null;#f=null;#m=null;#v=!1;#y=null;constructor(){super(),this.#t=this.attachShadow({mode:"open"}),this.#h=this.#A()}#A(){const e=new CSSStyleSheet;e.replaceSync(hu),this.#t.adoptedStyleSheets=[e]}get#p(){const e=this.getAttribute("variant");return e==="dropdown"||e==="sidebar"?e:"dialog"}get#b(){return(this.getAttribute("submit")||"auto")==="auto"}get#P(){return this.hasAttribute("collapsible")}connectedCallback(){const e=this.closest("dm-map");e&&(e.map?this.#x(e):e.addEventListener("dm-map:ready",()=>{this.#x(e)},{once:!0}))}async#x(e){if(this.#n=e,await this.#h,this.#_(),this.#C(),this.#G(),Ut(this.#t),this.#X(),this.#N(),this.#B(),this.hasAttribute("open")&&this.#p==="sidebar"){const s=this.#t.querySelector(".filter__panel--sidebar"),a=this.#t.querySelector(".filter__toggle");s?.classList.add("filter__panel--open"),a?.setAttribute("aria-expanded","true"),this.#u=!0}this.#et()&&(this.#d=!0,this.#a=JSON.parse(JSON.stringify(this.#i))),this.#y=()=>this.#et(!0),window.addEventListener("popstate",this.#y)}#_(){const e=["dm-geojson[filter-property], dm-geojson[filter-properties]","dm-wfs[filter-property], dm-wfs[filter-properties]","dm-layer[filter-property], dm-layer[filter-properties]"];this.#e=[],e.forEach(n=>{this.#n.querySelectorAll(n).forEach(s=>{const a=s.getAttribute("filter-properties"),l=s.getAttribute("filter-labels"),h=s.getAttribute("filter-property"),c=s.getAttribute("filter-label"),u=s.getAttribute("filter-types"),m=s.getAttribute("filter-collapsed");let v=[],g=[],_=[],w=[];if(a){for(v=a.split(",").map(E=>E.trim()).filter(Boolean),l&&(g=l.split(",").map(E=>E.trim()).filter(Boolean)),u&&(_=u.split(",").map(E=>E.trim()).filter(Boolean)),m&&(w=m.split(",").map(E=>E.trim()).filter(Boolean));g.length<v.length;)g.push(v[g.length]);for(;_.length<v.length;)_.push("auto");for(;w.length<v.length;)w.push("false")}else h&&(v=[h],g=[c||h],_=[u||"auto"],w=[m||"false"]);if(v.length===0)return;const x=s.id||`filter-source-${this.#e.length}`,S=s.getAttribute("filter-key");if(v.forEach((E,C)=>{this.#e.push({element:s,label:g[C],property:E,groupKey:S||E,type:s.tagName.toLowerCase(),id:x,filterType:_[C]||"auto",collapsed:w[C]==="true"})}),!this.#r.has(s))if(this.#r.set(s,!0),s.data)v.forEach(E=>{this.#w(s,E)});else{const E=s.tagName==="DM-GEOJSON"?"dm-geojson:ready":s.tagName==="DM-WFS"?"dm-wfs:ready":"dm-layer:ready";let C=!1;s.addEventListener(E,()=>{C||(C=!0,v.forEach(k=>{this.#w(s,k)}),this.#C(),this.#N(),this.#B())},{once:!0}),s.data&&!C&&(C=!0,v.forEach(k=>{this.#w(s,k)}))}})})}#C(){this.#o=new Map,this.#e.forEach(e=>{this.#o.has(e.groupKey)||this.#o.set(e.groupKey,{label:e.label,filterType:e.filterType,collapsed:e.collapsed,sources:[]});const n=this.#o.get(e.groupKey);n.sources.find(a=>a.element===e.element&&a.property===e.property)||n.sources.push({element:e.element,id:e.id,property:e.property})})}#L(e,n){const s=new Set;if(n.sources.forEach(({id:l,property:h})=>{const c=`${l}:${h}`,u=this.#l.get(c);u&&u.values.forEach(m=>s.add(m))}),s.size===0)return null;const a=Array.from(s).sort((l,h)=>typeof l=="number"&&typeof h=="number"?l-h:String(l).localeCompare(String(h)));return{values:a,valueType:this.#g(a)}}#w(e,n){const s=this.#S(e,n),a=this.#g(s),l=this.#e.find(c=>c.element===e&&c.property===n);if(!l)return;const h=`${l.id}:${n}`;this.#l.set(h,{values:s,valueType:a}),this.#d&&Object.keys(this.#i).length>0&&this.#I(),this.#U()&&(this.#N(),this.#B())}#S(e,n){if(!e.data?.features)return[];const s=new Set;return e.data.features.forEach(a=>{const l=a.properties?.[n];if(l!=null){const h=String(l);h.includes(",")?h.split(",").forEach(c=>{const u=c.trim();u&&s.add(u)}):s.add(l)}}),Array.from(s).sort((a,l)=>typeof a=="number"&&typeof l=="number"?a-l:String(a).localeCompare(String(l)))}#k(e,n){const s=new Map;return n.sources.forEach(({element:a,property:l})=>{a.data?.features&&a.data.features.forEach(h=>{const c=h.properties?.[l];if(c==null)return;const u=String(c);(u.includes(",")?u.split(",").map(v=>v.trim()).filter(Boolean):[u]).forEach(v=>{s.set(v,(s.get(v)||0)+1)})})}),s}#g(e){if(e.length===0)return{isNumeric:!1};if(e.length===1)return{isNumeric:!1,single:!0};if(e.every(s=>typeof s=="number"?!0:typeof s=="string"?!isNaN(Number(s))&&s.trim()!=="":!1)){const s=e.map(a=>Number(a));return{isNumeric:!0,min:Math.min(...s),max:Math.max(...s)}}return{isNumeric:!1}}#M(e,n){const s=this.#o.get(e)?.filterType;return s&&s!=="auto"?s==="range"&&!n.valueType.isNumeric?this.#O(n):s:this.#O(n)}#O({values:e,valueType:n}){return n.isNumeric&&!n.single?"range":e.length<=20?"checkbox":"dropdown"}#G(){const e=this.#p;e==="dropdown"?this.#Y():e==="sidebar"?this.#K():this.#j()}#T(){return`
		...
		`}#q(){const e=this.#b?" filter--auto-submit":"",n=this.getAttribute("label")||"Filters";return`
		...
		`}#j(){const e=this.getAttribute("label")||"Filters",n=this.#b?" filter--auto-submit":"";this.#t.innerHTML=`
			<div part="root" class="filter filter--dialog${n}">
				${this.#T()}

				<dialog id="filter-panel" part="dialog" class="filter__dialog" role="dialog" aria-modal="true" aria-label="${this.#E(e)}">
					${this.#q()}
				</dialog>

				<div role="status" aria-live="polite" aria-atomic="true" class="visually-hidden"></div>
			</div>
		`}#Y(){const e=this.getAttribute("label")||"Filters",n=this.#b?" filter--auto-submit":"";this.#t.innerHTML=`
			<div part="root" class="filter filter--dropdown${n}">
				${this.#T()}

				<div id="filter-panel" part="dropdown" class="filter__panel filter__panel--dropdown" role="region" aria-label="${this.#E(e)}">
					${this.#q()}
				</div>

				<div role="status" aria-live="polite" aria-atomic="true" class="visually-hidden"></div>
			</div>
		`}#K(){const e=this.getAttribute("label")||"Filters",n=this.#b?" filter--auto-submit":"";this.#t.innerHTML=`
			<div part="root" class="filter filter--sidebar${n}">
				${this.#T()}

				<div class="filter__overlay" part="overlay" aria-hidden="true"></div>

				<div id="filter-panel" part="sidebar" class="filter__panel filter__panel--sidebar" role="region" aria-label="${this.#E(e)}">
					${this.#q()}
				</div>

				<div role="status" aria-live="polite" aria-atomic="true" class="visually-hidden"></div>
			</div>
		`}#N(){if(!this.#v){this.#v=!0;try{const e=this.#t.querySelector(".filter__content");if(!e)return;if(this.#o.size===0){e.innerHTML='<p class="filter__empty">Geen filterbare gegevensbronnen gevonden.</p>';return}const n=[];this.#o.forEach((s,a)=>{let l=this.#L(a,s);if(l||(s.sources.forEach(({element:k,property:I})=>{k.data&&this.#w(k,I)}),l=this.#L(a,s)),!l||l.values.length===0){n.push(`
						<div class="filter__section" part="section" data-property="${this.#E(a)}">
							<h3 class="filter__section-title" part="section-title">${this.#F(s.label)}</h3>
					...
					`);return}const{values:h,valueType:c}=l,u=this.#M(a,l),m=s.collapsed,v=m?"false":"true",g=m?" hidden":"";if(u==="single"||c.single){n.push(`
						<div class="filter__section" part="section" data-property="${this.#E(a)}">
							${this.#z(s.label,a,v,g,`
								<p class="filter__single">Value: ${this.#F(String(h[0]))}</p>
							`)}
						</div>
						...
						<div class="filter__range">
							<label class="filter__range-label">
								...
								<input
									...
									max="${c.max}"
									value="${k}"
									step="${this.#it(c.min,c.max)}"
									aria-label="${this.#E(s.label)} minimum value"
								>
							</label>
							<label class="filter__range-label">
								...
								<input
									...
									value="${I}"
									step="${this.#it(c.min,c.max)}"
									aria-label="${this.#E(s.label)} maximum value"
								>
							</label>
						</div>`;n.push(`
						<div class="filter__section" part="section" data-property="${this.#E(a)}">
					...
					`);return}if(u==="checkbox"){const k=s.sources.reduce((q,{element:J})=>q||this.#lt(J),null),I=this.#k(a,s),B=h.map(q=>{const J=this.#Q(a,q)?"checked":"",ot=this.#E(String(q)),et=this.#F(String(q)),St=I.get(String(q))||0,Q=St>0?` (${St})`:"",ht=k?.[q]?this.#ht(k[q]):this.#J();return`
						...
						<fieldset class="filter__fieldset">
							<legend class="visually-hidden">${this.#F(s.label)}</legend>
							${B}
						</fieldset>`;n.push(`
						<div class="filter__section" part="section" data-property="${this.#E(a)}">
							${this.#z(s.label,a,v,g,H)}
						</div>
					`);return}const _=this.#i[a]||[],w=_.map(k=>{const I=this.#E(String(k)),B=this.#F(String(k));return`
					...
					`}).join(""),x=h.filter(k=>!_.includes(String(k))).map(k=>{const I=this.#E(String(k)),B=this.#F(String(k));return`
							<div class="filter__option" data-value="${I}" role="option" tabindex="0">
								${B}
							</div>
						`}).join(""),S=`filter-select-${a}`,E=_.length===0?"Selecteer waarden...":"",C=`
					<div class="filter__custom-select" part="select" id="${S}" role="combobox" aria-expanded="false" aria-haspopup="listbox" aria-label="${this.#E(s.label)}" tabindex="0">
					...
					<div class="filter__section" part="section" data-property="${this.#E(a)}">
						${this.#z(s.label,a,v,g,C)}
					</div>
				`)}),e.innerHTML=n.join("")}finally{this.#v=!1}}}#z(e,n,s,a,l){if(this.#P){const h=`filter-section-${this.#E(n)}`;return`
				<button type="button" part="section-toggle" class="filter__section-toggle" aria-expanded="${s}" aria-controls="${h}">
					<span class="filter__section-toggle-text">${this.#F(e)}</span>
			...
			<h3 class="filter__section-title" part="section-title">${this.#F(e)}</h3>
			${l}`}#U(){return this.#p==="dialog"?this.#t.querySelector("dialog")?.open??!1:this.#u}#$(){const e=this.#p,n=this.#t.querySelector(".filter__toggle");if(this.#N(),this.#B(),e==="dialog")this.#t.querySelector("dialog").showModal(),n.setAttribute("aria-expanded","true");else if(e==="dropdown"){const s=this.#t.querySelector(".filter__panel--dropdown"),a=()=>{const l=n.getBoundingClientRect(),h=this.closest("dm-map"),c=h?h.getBoundingClientRect():null;s.style.top=`${l.bottom+4}px`,c?(s.style.left=`${c.left}px`,s.style.right=`${window.innerWidth-c.right}px`,s.style.inlineSize="auto"):(s.style.left="",s.style.right=`${window.innerWidth-l.right}px`,s.style.inlineSize="")};a(),s.classList.add("filter__panel--open"),n.setAttribute("aria-expanded","true"),this.#u=!0,this.#f=a,window.addEventListener("scroll",this.#f,{passive:!0,capture:!0}),this.#c=l=>{l.composedPath().some(h=>h===s||h===n)||this.#R()},requestAnimationFrame(()=>{document.addEventListener("click",this.#c,!0)}),this.#t.addEventListener("keydown",this.#H)}else if(e==="sidebar"){const s=this.#t.querySelector(".filter__panel--sidebar"),a=this.#t.querySelector(".filter__overlay");s.classList.add("filter__panel--open"),a.classList.add("filter__overlay--visible"),n.setAttribute("aria-expanded","true"),this.#u=!0,this.#t.addEventListener("keydown",this.#H)}}#R(){const e=this.#p,n=this.#t.querySelector(".filter__toggle");if(e==="dialog")this.#t.querySelector("dialog").close();else if(e==="dropdown")this.#t.querySelector(".filter__panel--dropdown")?.classList.remove("filter__panel--open"),this.#u=!1,this.#f&&(window.removeEventListener("scroll",this.#f,{capture:!0}),this.#f=null),this.#c&&(document.removeEventListener("click",this.#c,!0),this.#c=null),this.#t.removeEventListener("keydown",this.#H);else if(e==="sidebar"){const s=this.#t.querySelector(".filter__panel--sidebar"),a=this.#t.querySelector(".filter__overlay");s?.classList.remove("filter__panel--open"),a?.classList.remove("filter__overlay--visible"),this.#u=!1,this.#t.removeEventListener("keydown",this.#H)}n.setAttribute("aria-expanded","false"),n.focus()}#H=e=>{e.key==="Escape"&&this.#R()};#X(){this.#t.querySelector(".filter__toggle").addEventListener("click",()=>{this.#U()?this.#R():this.#$()});const e=this.#t.querySelector('slot[name="header"]');if(e){const n=()=>{const s=e.assignedNodes().length>0;e.closest(".filter__header-text")?.classList.toggle("filter__header-text--empty",!s)};e.addEventListener("slotchange",n),n()}if(this.#t.querySelector(".filter__apply").addEventListener("click",()=>{this.#D(),this.#I(),this.#p==="dialog"&&this.#R()}),this.#t.querySelector(".filter__reset").addEventListener("click",()=>this.#V()),this.#t.querySelector(".filter__close").addEventListener("click",()=>this.#R()),this.#p==="dialog"){const n=this.#t.querySelector("dialog");n.addEventListener("close",()=>{const s=this.#t.querySelector(".filter__toggle");s.setAttribute("aria-expanded","false"),s.focus()}),n.addEventListener("click",s=>{s.target===n&&this.#R()})}this.#p==="sidebar"&&this.#t.querySelector(".filter__overlay")?.addEventListener("click",()=>this.#R())}#W(e){const n=e.querySelector(".filter__custom-select-display"),s=e.querySelector(".filter__custom-select-dropdown");if(!n||!s)return;const a=n.getBoundingClientRect(),l=4,h=240,c=window.innerHeight,u=c-a.bottom-l,m=a.top-l,v=u<160&&m>u,g=v?m:u;s.style.left=`${a.left}px`,s.style.width=`${a.width}px`,s.style.maxBlockSize=`${Math.max(120,Math.min(h,g))}px`,v?(s.style.top="auto",s.style.bottom=`${c-a.top+l}px`):(s.style.bottom="auto",s.style.top=`${a.bottom+l}px`)}#B(){const e=this.#t.querySelector(".filter__content");if(!e)return;this.#m?.abort(),this.#m=new AbortController;const{signal:n}=this.#m,s=this.#b;e.querySelectorAll(".filter__section-toggle").forEach(a=>{a.addEventListener("click",()=>{const l=a.getAttribute("aria-expanded")==="true",h=a.getAttribute("aria-controls"),c=this.#t.getElementById(h);c&&(a.setAttribute("aria-expanded",l?"false":"true"),l?c.setAttribute("hidden",""):c.removeAttribute("hidden"))},{signal:n})}),e.querySelectorAll(".filter__checkbox").forEach(a=>{a.addEventListener("change",()=>{this.#D(),s?this.#I():this.#Z()},{signal:n})}),e.querySelectorAll(".filter__custom-select").forEach(a=>{a.addEventListener("click",l=>{if(l.target.closest(".filter__chip-remove"))return;const h=a.getAttribute("aria-expanded")==="true";if(e.querySelectorAll(".filter__custom-select").forEach(c=>{c.setAttribute("aria-expanded","false")}),a.setAttribute("aria-expanded",h?"false":"true"),!h){this.#W(a);const c=a.querySelector(".filter__option");c&&setTimeout(()=>c.focus(),0)}},{signal:n}),a.addEventListener("keydown",l=>{if(l.key==="Enter"||l.key===" "){l.preventDefault();const h=a.getAttribute("aria-expanded")==="true";if(a.setAttribute("aria-expanded",h?"false":"true"),!h){this.#W(a);const c=a.querySelector(".filter__option");c&&setTimeout(()=>c.focus(),0)}}else if(l.key==="Escape")a.setAttribute("aria-expanded","false"),a.focus();else if(l.key==="ArrowDown"){l.preventDefault();const h=[...a.querySelectorAll(".filter__option")],c=h.indexOf(this.#t.activeElement);(h[c+1]||h[0])?.focus()}else if(l.key==="ArrowUp"){l.preventDefault();const h=[...a.querySelectorAll(".filter__option")],c=h.indexOf(this.#t.activeElement);(h[c-1]||h[h.length-1])?.focus()}},{signal:n})}),e.querySelectorAll(".filter__option").forEach(a=>{a.addEventListener("click",l=>{const c=l.target.closest(".filter__section").dataset.property,u=l.target.dataset.value;this.#i[c]||(this.#i[c]=[]),this.#i[c].push(u),this.#N(),this.#B(),s?this.#I():this.#Z()},{signal:n}),a.addEventListener("keydown",l=>{l.key==="Enter"&&(l.preventDefault(),a.click())},{signal:n})}),e.querySelectorAll(".filter__chip-remove").forEach(a=>{a.addEventListener("click",l=>{l.stopPropagation();const h=l.target.closest(".filter__chip"),u=l.target.closest(".filter__section").dataset.property,m=h.dataset.value;this.#i[u]&&(this.#i[u]=this.#i[u].filter(v=>v!==m),this.#i[u].length===0&&delete this.#i[u]),this.#N(),this.#B(),s?this.#I():this.#Z()},{signal:n})}),this.#t.addEventListener("click",a=>{a.composedPath().some(l=>l?.classList?.contains("filter__custom-select"))||e.querySelectorAll(".filter__custom-select").forEach(l=>{l.setAttribute("aria-expanded","false")})},{signal:n}),e.querySelectorAll(".filter__range-input").forEach(a=>{const l=a.closest(".filter__section")?.dataset.property||"unknown",h=this.#nt(()=>{this.#D(),s?this.#I():this.#Z()},150,`range-${l}-${a.dataset.bound}`);a.addEventListener("input",c=>{const u=c.target.closest("label").querySelector("output");u&&(u.textContent=c.target.value),h()},{signal:n}),a.addEventListener("change",()=>{this.#D(),s?this.#I():this.#Z()},{signal:n})})}#D(){const e={};this.#t.querySelectorAll(".filter__section").forEach(n=>{const s=n.dataset.property,a=n.querySelectorAll(".filter__checkbox");if(a.length>0){const c=Array.from(a).filter(u=>u.checked).map(u=>u.value);c.length>0&&(e[s]=c);return}const l=n.querySelectorAll(".filter__chip");if(l.length>0){const c=Array.from(l).map(u=>u.dataset.value);c.length>0&&(e[s]=c);return}if(n.querySelectorAll(".filter__range-input").length===2){const c=n.querySelector('[data-bound="min"]'),u=n.querySelector('[data-bound="max"]');c&&u&&(e[s]={min:Number(c.value),max:Number(u.value)})}}),this.#i=e,this.#d=!1}#Z(){const e=this.#t.querySelector(".filter__apply");if(e){const n=JSON.stringify(this.#i)!==JSON.stringify(this.#a);e.classList.toggle("filter__apply--dirty",n)}}#I(){const e=new Map;this.#o.forEach((a,l)=>{const h=this.#i[l];a.sources.forEach(({element:c,property:u})=>{e.has(c)||e.set(c,{}),h!==void 0&&(e.get(c)[u]=h)})}),e.forEach((a,l)=>{l.dispatchEvent(new CustomEvent("dm-filter:apply",{bubbles:!1,detail:{filters:a}}))}),this.#a=JSON.parse(JSON.stringify(this.#i)),this.#tt();const n=this.#t.querySelector(".filter__apply");n&&n.classList.remove("filter__apply--dirty");const s=Object.keys(this.#i).length;this.#nt(()=>{this.#rt(s>0?`${s} filter${s!==1?"s":""} actief`:"Alle filters gewist")},500,"announce")()}#V(){this.#i={},this.#d=!1;const e=new Set;this.#o.forEach(s=>{s.sources.forEach(({element:a})=>e.add(a))}),e.forEach(s=>{s.dispatchEvent(new CustomEvent("dm-filter:apply",{bubbles:!1,detail:{filters:{}}}))}),this.#a={},this.#tt(),this.#rt("Alle filters zijn gewist"),this.#N(),this.#B();const n=this.#t.querySelector(".filter__apply");n&&n.classList.remove("filter__apply--dirty")}#Q(e,n){const s=this.#i[e];return!s||!Array.isArray(s)?!1:s.includes(String(n))}#tt(){try{const e=new URL(window.location.href);Object.keys(this.#i).length===0?e.searchParams.delete("filters"):e.searchParams.set("filters",this.#st(this.#i)),window.history.pushState({},"",e)}catch{}}#et(e=!1){try{const n=new URLSearchParams(window.location.search).get("filters");if(!n)return!1;const s=this.#at(n);return this.#i=s,e&&this.#I(),!0}catch{return!1}}#st(e){return btoa(encodeURIComponent(JSON.stringify(e)))}#at(e){if(e.length>1e4)return{};const n=decodeURIComponent(atob(e));return this.#ot(JSON.parse(n))}#ot(e){if(typeof e!="object"||e===null||Array.isArray(e))return{};const n={};for(const[s,a]of Object.entries(e))Array.isArray(a)&&a.every(l=>typeof l=="string")?n[s]=a:a&&typeof a=="object"&&!Array.isArray(a)&&typeof a.min=="number"&&typeof a.max=="number"&&(n[s]={min:a.min,max:a.max});return n}#it(e,n){const s=n-e;return s<=10?.1:s<=100?1:s<=1e3?10:100}#F(e){const n=document.createElement("div");return n.textContent=e,n.innerHTML}#E(e){return String(e).replace(/&/g,"&amp;").replace(/"/g,"&quot;").replace(/'/g,"&#39;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}#lt(e){const n=e.getAttribute("filter-icons");if(!n)return null;try{return JSON.parse(n)}catch{return null}}#J(){return`<svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
			<circle cx="10" cy="10" r="7" stroke="currentColor" stroke-width="1.5" fill="none"/>
		</svg>`}#ht(e){if(!e||typeof e!="string")return this.#J();try{const n=new DOMParser().parseFromString(e,"image/svg+xml");if(n.querySelector("parsererror"))return this.#J();const s=n.querySelector("svg");return s?(s.querySelectorAll("script, foreignObject, object, embed, iframe").forEach(a=>a.remove()),s.querySelectorAll("*").forEach(a=>{for(const l of[...a.attributes])(l.name.startsWith("on")||l.name==="href"||l.name==="xlink:href"||l.name.toLowerCase().includes("javascript"))&&a.removeAttribute(l.name)}),s.querySelectorAll("[href], [xlink\\:href]").forEach(a=>{const l=a.getAttribute("href")||a.getAttribute("xlink:href");l&&l.toLowerCase().includes("javascript:")&&a.remove()}),s.outerHTML):this.#J()}catch{return this.#J()}}#nt(e,n=150,s="default"){return(...a)=>{this.#s.has(s)&&clearTimeout(this.#s.get(s));const l=setTimeout(()=>{e.apply(this,a),this.#s.delete(s)},n);this.#s.set(s,l)}}#rt(e){const n=this.#t.querySelector('[role="status"]');n&&(n.textContent="",setTimeout(()=>{n.textContent=e},100))}get activeFilterCount(){return Object.keys(this.#i).length}getFilterState(){return JSON.parse(JSON.stringify(this.#i))}resetFilters(){this.#V()}exportFilters(){return JSON.stringify(this.#i)}disconnectedCallback(){this.#s.forEach(e=>clearTimeout(e)),this.#s.clear(),this.#m?.abort(),this.#m=null,this.#c&&(document.removeEventListener("click",this.#c,!0),this.#c=null),this.#y&&(window.removeEventListener("popstate",this.#y),this.#y=null),this.#e=[],this.#i={},this.#a={},this.#l.clear(),this.#o.clear(),this.#n=null}}return customElements.define("dm-filter",cu),Ge.ICON_SPRITE=jd,Ge.registerIcons=Ud,Ge.setIconSprite=Hd,Object.defineProperty(Ge,Symbol.toStringTag,{value:"Module"}),Ge})({});
